  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Master mathematical concepts, problem-solving techniques, and advance your quantitative skills"
        />
      </Head>
        ...
        <section className="relative bg-gradient-to-r from-primary to-blue-600 text-white py-20">
          <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            <p className="text-2xl mb-8 max-w-3xl mx-auto">
              Master mathematical concepts, problem-solving techniques, and advance your
              quantitative skills
            </p>
