...
export default function Login() {
  ...
  return (
    <>
      <Head>
        <title>Log In - Learn Mathematics</title>
        <meta name="description" content="Log in to Learn Mathematics" />
      </Head>
      
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
          <h1 className="text-3xl font-bold text-primary mb-6 text-center">Log In</h1>
          <p className="text-center text-charcoal mb-6">Welcome back to Learn Mathematics</p>
