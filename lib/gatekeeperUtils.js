...
import gatekeeperData from '../data/gatekeeperQuestions.json';
 ...
 */
export function getGatekeeperQuestions(appId, tier) {
 ...
 */
export function getAllGatekeeperQuestions(appId) {
  return {
 ...
 */
export function getSubjectName(appId) {
 ...
 */
export function hasGatekeeperQuestions(appId) {
