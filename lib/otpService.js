 ...
 * - Supports SMS (via Twilio) and Email (via SendGrid/Resend)
...
// Initialize Twilio (optional - may not be configured in all environments)
...
async function sendOTPViaSMS(phone, otp, appId, appName) {
  ...
  try {
    await twilioClient.messages.create({
      body: `Your iiskills.cloud OTP for ${appName}: ${otp}. Valid for 10 minutes. Do not share this code.`,
