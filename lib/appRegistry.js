...
export const APPS = {
  ...
  admin: {
    ...
    name: 'iiskills Admin',
    subdomain: 'admin',
    primaryDomain: 'admin.iiskills.cloud',
    localPort: 3023,
    postLoginRedirect: '/admin',
    postRegisterRedirect: '/admin',
    features: ['admin-only'],
    isFree: false,
  },
  'learn-ai': {
  ...
  'learn-jee': {
    ...
    name: 'Learn-Jee',
    subdomain: 'learn-jee',
    primaryDomain: 'learn-jee.iiskills.cloud',
    localPort: 3003,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  'learn-cricket': {
    ...
    primaryDomain: 'learn-cricket.iiskills.cloud',
    localPort: 3009,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
    isFree: true, // Cricket is free
  },
  'learn-data-science': {
    id: 'learn-data-science',
    name: 'Learn-Data Science',
    subdomain: 'learn-data-science',
    primaryDomain: 'learn-data-science.iiskills.cloud',
    localPort: 3010,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  'learn-ias': {
    ...
    name: 'Learn-IAS',
    subdomain: 'learn-ias',
    primaryDomain: 'learn-ias.iiskills.cloud',
    localPort: 3014,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  'learn-leadership': {
    ...
    primaryDomain: 'learn-leadership.iiskills.cloud',
    localPort: 3015,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  'learn-neet': {
    id: 'learn-neet',
    name: 'Learn-NEET',
    subdomain: 'learn-neet',
    primaryDomain: 'learn-neet.iiskills.cloud',
    localPort: 3006,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  'learn-winning': {
    ...
    primaryDomain: 'learn-winning.iiskills.cloud',
    localPort: 3018,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
 ...
 * @param {string} appId - App identifier (e.g., 'main', 'learn-jee')
 ...
 * @param {string} subdomain - Subdomain (e.g., 'learn-jee')
 * @returns {Object|null} App configuration object or null if not found
 */
 ...
 * @param {string} domain - Full domain (e.g., 'learn-jee.iiskills.cloud' or 'iiskills.cloud')
 * @returns {Object|null} App configuration object or null if not found
 */
...
export function getAccessibleApps(user, isAdmin = false) {
  ...
  // Regular authenticated users can access free apps
  // TODO: Add payment/subscription check here
  // For now, return free apps only
  return getFreeApps();
}
