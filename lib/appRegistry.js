...
export const APPS = {
  ...
  'learn-developer': {
    ...
    primaryDomain: 'app1.learn-developer.iiskills.cloud',
    localPort: 3010,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  //   primaryDomain: 'app11.learn-finesse.iiskills.cloud',
  //   localPort: 3025,
  //   postLoginRedirect: '/learn',
  //   postRegisterRedirect: '/learn',
  //   features: ['simplified-registration', 'courses'],
  ...
  //   primaryDomain: 'app12.learn-biology.iiskills.cloud',
  //   localPort: 3026,
  //   postLoginRedirect: '/learn',
  //   postRegisterRedirect: '/learn',
  //   features: ['simplified-registration', 'courses'],
  ...
  //   subdomain: 'mpa',
  //   primaryDomain: 'app13.mpa.iiskills.cloud',
  //   localPort: 3014,
  //   postLoginRedirect: '/',
 ...
 * @param {string} domain - Full domain (e.g., 'app1.learn-ai.iiskills.cloud' or 'app.iiskills.cloud')
 * @returns {Object|null} App configuration object or null if not found
 */
