...
export const APPS = {
  ...
  'learn-ai': {
    ...
    name: 'Learn-AI',
    subdomain: 'learn-ai',
    primaryDomain: 'app1.learn-ai.iiskills.cloud',
    localPort: 3001,
  ...
  'learn-apt': {
    ...
    name: 'Learn-Apt',
    subdomain: 'learn-apt',
    primaryDomain: 'app1.learn-apt.iiskills.cloud',
    localPort: 3002,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  'learn-chemistry': {
    ...
    primaryDomain: 'app1.learn-chemistry.iiskills.cloud',
    localPort: 3005,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  'learn-cricket': {
    ...
    primaryDomain: 'app1.learn-cricket.iiskills.cloud',
    localPort: 3009,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  'learn-geography': {
    ...
    primaryDomain: 'app1.learn-geography.iiskills.cloud',
    localPort: 3011,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  'learn-govt-jobs': {
    ...
    primaryDomain: 'app1.learn-govt-jobs.iiskills.cloud',
    localPort: 3013,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  'learn-leadership': {
    ...
    primaryDomain: 'app1.learn-leadership.iiskills.cloud',
    localPort: 3015,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  'learn-management': {
    ...
    primaryDomain: 'app1.learn-management.iiskills.cloud',
    localPort: 3016,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  'learn-math': {
    ...
    primaryDomain: 'app1.learn-math.iiskills.cloud',
    localPort: 3017,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  'learn-physics': {
    ...
    primaryDomain: 'app1.learn-physics.iiskills.cloud',
    localPort: 3020,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  'learn-pr': {
    ...
    name: 'Learn-PR',
    subdomain: 'learn-pr',
    primaryDomain: 'app1.learn-pr.iiskills.cloud',
    localPort: 3021,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
  ...
  'learn-winning': {
    ...
    primaryDomain: 'app1.learn-winning.iiskills.cloud',
    localPort: 3022,
    postLoginRedirect: '/learn',
    postRegisterRedirect: '/learn',
    features: ['simplified-registration', 'courses'],
