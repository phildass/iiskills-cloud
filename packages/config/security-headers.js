...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      // iiskills.cloud and all *.iiskills.cloud sub-apps must be able to call
      // the main-app APIs (e.g. /api/entitlement, /api/admin/me) cross-subdomain.
      // Without this the entitlement API call from learn-*.iiskills.cloud is
      // blocked by the browser before it even reaches the server, causing the
      // useUserAccess hook to catch a network error and incorrectly fall back
      // to ACCESS_LEVEL.NONE — showing the paywall to all users, including admins.
      "connect-src 'self' https://iiskills.cloud https://*.iiskills.cloud https://*.supabase.co https://api.razorpay.com https://lumberjack.razorpay.com wss://*.supabase.co https://translate.googleapis.com https://translate-pa.googleapis.com https://translate.google.com",
