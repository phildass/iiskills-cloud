  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={`The page you're looking for doesn't exist on ${appName}.`}
        />
      </Head>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl shadow-lg p-8 mb-8 border-2 border-blue-200">
            ...
            <p className="text-sm text-gray-600">
              Part of the iiskills.cloud platform - Indian Institute of Professional Skills
              Development
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6 mb-8 border-2 border-green-200">
            ...
            <p className="text-gray-700 mb-4">
              Choose your learning path: Basic (beginner-friendly), Intermediate (real-world
              applications), or Advanced (expert mastery). Not sure? Take our diagnostic quiz to
