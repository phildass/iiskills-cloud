      ...
      <div className="job-header">
        ...
        {content.salary && (
          <div className="mt-2 text-lg font-semibold text-green-600 dark:text-green-400">
            {content.salary.currency} {content.salary.min.toLocaleString()} -{" "}
            {content.salary.max.toLocaleString()}
          </div>
        )}
      </div>
  ...
  return (
    <div className="fallback-container p-6 bg-yellow-50 dark:bg-yellow-900 rounded-lg">
      ...
      <p className="mt-2 text-yellow-800 dark:text-yellow-200">
        No renderer available for content type:{" "}
        <code className="px-2 py-1 bg-yellow-200 dark:bg-yellow-800 rounded">
          {module.content_type}
        </code>
      </p>
...
export const ModuleSwitcher: React.FC<ModuleSwitcherProps> = ({
  ...
  switch (module.content_type) {
    case "lesson": {
      ...
      return (
        <LessonRenderer
          module={module as Module<"lesson">}
    ...
    case "test": {
      ...
      return (
        <TestRenderer module={module as Module<"test">} onComplete={onComplete} onError={onError} />
      );
    }
    ...
    case "job_posting": {
      ...
      return (
        <JobPostingRenderer
          module={module as Module<"job_posting">}
          onComplete={onComplete}
          onError={onError}
        />
      );
