...
// A real Supabase anon key is a JWT that starts with "eyJ" and is 40+ chars long.
const hasValidUrl =
...
const isMissingCredentials = !useLocalContent && !isAuthDisabled && (!hasValidUrl || !hasValidKey);
if (isMissingCredentials) {
  ...
  const keyNote = !supabaseAnonKey
    ? " (not set)"
    : !hasValidKey
      ? " (invalid — expected a Supabase key starting with eyJ or sb_, 40+ chars)"
      : "";
  const errorMessage = [
    "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
...
if (useLocalContent) {
  // Only usable in Node.js environment (not browser); localContentProvider uses Node.js fs/path.
