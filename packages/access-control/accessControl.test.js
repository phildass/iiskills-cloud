...
describe("Access Control - Core Functions", () => {
  ...
  describe("userHasAccess()", () => {
    ...
    test("allows access with valid app_access record", () => {
      const user = {
        id: "user-123",
        app_access: [{ app_id: "learn-ai", is_active: true, expires_at: null }],
      };
    ...
    test("denies access with inactive record", () => {
      const user = {
        id: "user-123",
        app_access: [{ app_id: "learn-ai", is_active: false, expires_at: null }],
      };
    ...
    test("denies access with expired record", () => {
      ...
      const user = {
        id: "user-123",
        app_access: [{ app_id: "learn-ai", is_active: true, expires_at: pastDate }],
      };
      expect(userHasAccess(user, "learn-ai")).toBe(false);
    });
    ...
    test("allows access with future expiration", () => {
      ...
      const user = {
        id: "user-123",
        app_access: [{ app_id: "learn-ai", is_active: true, expires_at: futureDate }],
      };
      expect(userHasAccess(user, "learn-ai")).toBe(true);
    });
  ...
  describe("hasAccessViaBundle()", () => {
    test("returns true for bundle-granted access", () => {
      const user = {
        id: "user-123",
        app_access: [{ app_id: "learn-developer", is_active: true, granted_via: "bundle" }],
      };
    ...
    test("returns false for payment-granted access", () => {
      const user = {
        id: "user-123",
        app_access: [{ app_id: "learn-ai", is_active: true, granted_via: "payment" }],
      };
