 ...
 *
 * Pricing rules:
 *  - From 2026-03-21 to 2026-04-20 (inclusive, local date):
...
/** Launch date of the inaugural offer (display only). */
export const OFFER_START_DATE = "2026-03-21";
...
export function getIntroOfferNotice(date = new Date()) {
  ...
  return `🎉 Inaugural Offer: Rs ${OLD_TOTAL.toFixed(2)} (Rs 99 + 18% GST) valid from March 21, 2026 to April 20, 2026. Standard price Rs ${NEW_TOTAL.toFixed(2)} effective from April 21, 2026. Enroll now!`;
}
