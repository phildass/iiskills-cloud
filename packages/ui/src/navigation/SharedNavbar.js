      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center gap-6">
        ...
        <div className="hidden md:flex flex-wrap gap-4 xl:gap-6 font-medium items-center justify-end flex-1">
          ...
          {showAuthButtons && (
            <>
              {user ? (
                // User is logged in - show name/username, Google badge, and logout button
                <>
                  <span className="text-base text-gray-600 whitespace-nowrap flex items-center gap-1.5">
                    ...
                    {isPaid && (
                      <span className="ml-1 inline-block bg-gradient-to-r from-purple-600 to-blue-600 text-white text-xs font-bold px-2 py-0.5 rounded-full align-middle">
                        PAID
                      </span>
                    )}
                  </span>
          ...
          {showAuthButtons && (
            <>
              {user ? (
                // User is logged in - show name/username, Google badge, and logout button
                <>
                  <div className="text-base text-gray-600 px-4 py-2 bg-gray-50 rounded flex items-center gap-2 flex-wrap">
                    {user.user_metadata?.full_name ||
                      user.user_metadata?.first_name ||
                      user.user_metadata?.name ||
                      user.user_metadata?.username ||
