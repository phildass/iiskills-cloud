 ...
 */
const SHARED_HERO_POOL = ["hero1.jpg", "hero2.jpg", "hero3.jpg"];

/**
 * Fallback: Cricket-specific hero images pool
 */
const CRICKET_HERO_POOL = ["cricket1.jpg", "cricket2.jpg"];
 ...
 * SharedHero Component
 */
export default function SharedHero({ appName, children, className = "" }) {
