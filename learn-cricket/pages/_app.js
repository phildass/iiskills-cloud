...
export default function App({ Component, pageProps }) {
  ...
  const subdomainSections = [
    {
      label: "Home",
      href: "/",
      description: "Welcome to Cricket Know-All",
    },
    {
      label: "Learning Content",
      href: "/learn",
      description: "Access cricket learning materials",
    },
    {
      label: "Login",
      href: "/login",
  ...
  return (
    <ErrorBoundary>
      ...
      />
      <SubdomainNavbar subdomainName="Cricket Know-All" sections={subdomainSections} />
      <Component {...pageProps} />
      <Footer />
