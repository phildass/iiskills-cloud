  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Privacy Policy for iiskills.cloud and Indian Institute of Professional Skills Development"
        />
      </Head>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-6">
          <section>
            ...
            <p className="text-charcoal leading-relaxed">
              ...
              Professional Skills Development ("IISKILLS," "we," "us," or "our"). This Privacy
              Policy explains how we collect, use, disclose, and safeguard your information when you
              visit our website and use our services. By accessing or using iiskills.cloud, you
              agree to this Privacy Policy. If you do not agree, please do not use our platform.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-charcoal space-y-1 ml-4">
              ...
              <li>
                Send promotional materials (with your consent, and you may opt out at any time)
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-charcoal leading-relaxed">
              ...
              However, no internet-based service is completely secure, and we cannot guarantee
              absolute security.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-charcoal leading-relaxed">
              ...
              usage, and deliver personalized content. You can control cookie settings through your
              browser, but disabling cookies may limit certain features of our platform.
            </p>
          </section>
