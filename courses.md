# iiskills.cloud Course Catalog

Complete list of courses offered on iiskills.cloud platform, organized by category.
...
- Bread Making (Roti, Naan, Paratha)
- Rice Dishes and Biryanis
- Curries and Gravies
...
- Coordinate Geometry/Ecology (JEE/NEET)
- Trigonometry/Biotechnology (JEE/NEET)
...
- General Awareness
- General Science
- Technical Subjects (for Technical Posts)
- Previous Year Questions
- Mock Tests
- Speed Enhancement
- Exam Strategy
...
- Advanced Analytics in Tableau/Power BI
