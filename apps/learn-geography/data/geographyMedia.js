...
const geographyMedia = {
  ...
  2: {
    mapUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/India_relief_location_map.jpg/800px-India_relief_location_map.jpg",
  ...
  4: {
    mapUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/World_trade_map_2011.png/1280px-World_trade_map_2011.png",
  ...
  5: {
    mapUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/World_population_density_map.PNG/1280px-World_population_density_map.PNG",
  ...
  6: {
    mapUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/The_Amazon_basin.jpg/1280px-The_Amazon_basin.jpg",
  ...
  7: {
    mapUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/United_Nations_Members.svg/1280px-United_Nations_Members.svg.png",
  ...
  9: {
    mapUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Topographic_map_example.png/1280px-Topographic_map_example.png",
...
const lessonMedia = {
  ...
  "1_2": {
    mapUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Plate_tectonic_map.gif/800px-Plate_tectonic_map.gif",
