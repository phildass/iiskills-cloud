...
export default function Courses() {
  return (
    <>
      <Head>
        <title>Courses — Learn Geography</title>
        <meta
          name="description"
          content="Choose from 3 structured courses: Basic, Intermediate, and Advanced Geography. Each course contains 10 modules and 100 lessons."
        />
      </Head>
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Geography Courses</h1>
