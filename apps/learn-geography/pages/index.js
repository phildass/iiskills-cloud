...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const appImages = getLandingPageImages("geography");
    setImages(appImages);
  }, []);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Explore world geography, physical features, cultures, and global interconnections" />
      </Head>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
              <div className="flex-1 text-center md:text-left z-10 space-y-6">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl leading-relaxed">
                  Explore world geography, physical features, cultures, and global interconnections
                </p>
              ...
              {images[0] && (
                <div className="flex-1 relative z-10 w-full">
                  ...
                  >
                    <Image
                      src={images[0]}
                      alt={`Learn Geography - Hero Image`}
                      fill
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            {images[1] && (
              <div className="flex justify-center mb-12">
                <div className="relative w-full max-w-md rounded-lg overflow-hidden shadow-xl">
                  <Image
                    src={images[1]}
                    alt={`Learn Geography - Features Image`}
                    width={600}
                    height={800}
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-neutral p-8 rounded-lg shadow">
                ...
                <h3 className="text-2xl font-bold text-accent mb-4">World Geography</h3>
                <p className="text-charcoal leading-relaxed">
                  Study continents, countries, and their unique geographical characteristics.
                </p>
              </div>

              <div className="bg-neutral p-8 rounded-lg shadow">
                <div className="text-5xl mb-4">🗺️</div>
                <h3 className="text-2xl font-bold text-accent mb-4">Physical Geography</h3>
                <p className="text-charcoal leading-relaxed">
                  Understand landforms, climate patterns, and natural phenomena.
                </p>
              </div>

              <div className="bg-neutral p-8 rounded-lg shadow">
                <div className="text-5xl mb-4">🏛️</div>
                <h3 className="text-2xl font-bold text-accent mb-4">Cultural Geography</h3>
                <p className="text-charcoal leading-relaxed">
                  Learn about diverse cultures, civilizations, and human geography.
                </p>
              </div>
            </div>
          </div>
