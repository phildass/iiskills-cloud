...
Learn AI is a self-paced online course platform designed to take students from AI fundamentals to monetization strategies. The platform includes:
...
The app will be available at `http://localhost:3024`
...
# Deploy with PM2
pm2 start ecosystem.config.js --only learn-ai
```
