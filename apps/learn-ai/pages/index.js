...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const appImages = getLandingPageImages("ai");
    setImages(appImages);
  }, []);
  ...
  return (
    <>
      <Head>
        <title>Learn AI - iiskills.cloud</title>
        <meta name="description" content="Explore Artificial Intelligence fundamentals, applications, and prepare for the AI-driven future" />
      </Head>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-neutral p-8 rounded-lg shadow">
                ...
                <h3 className="text-2xl font-bold text-accent mb-4">Comprehensive Content</h3>
              ...
              <div className="bg-neutral p-8 rounded-lg shadow">
                <div className="text-5xl mb-4">🎯</div>
                <h3 className="text-2xl font-bold text-accent mb-4">Practical Skills</h3>
                <p className="text-charcoal leading-relaxed">
              ...
              <div className="bg-neutral p-8 rounded-lg shadow">
                <div className="text-5xl mb-4">🏆</div>
                <h3 className="text-2xl font-bold text-accent mb-4">Certification</h3>
                <p className="text-charcoal leading-relaxed">
