...
const ADVANCED_QUESTIONS = [
  {
    question:
      "Which technique is commonly used to adapt a pre-trained LLM to a specific domain with minimal compute?",
    options: [
...
const LEARNING_PATHS = [
  {
    ...
    emoji: "🟢",
    description:
      "Start with AI fundamentals — what AI is, types of ML, and real-world applications.",
    requiresTest: false,
  },
  {
    id: "intermediate",
    ...
    emoji: "🔵",
    description:
      "Apply AI concepts — neural networks, prompt engineering, and ML model evaluation.",
    requiresTest: true,
  ...
  },
  {
    ...
    emoji: "🟣",
    description:
      "Master production AI — LLM fine-tuning, RAG systems, deployment, and model monitoring.",
    requiresTest: true,
          ...
          <div className="container mx-auto px-4 max-w-2xl text-center">
            <div className="bg-white rounded-2xl shadow-lg p-10">
              ...
              <p className="text-lg text-gray-700 mb-6">
                ...
                path. Your AI journey begins now!
              </p>
              <a
                href="/curriculum"
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Start Your AI Journey</h1>
