 ...
 * Protected Route: Redirects to login if user is not authenticated and paid
 */
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            ...
            <p className="text-gray-700 mb-6">
              Our comprehensive assessment evaluates multiple dimensions of your abilities and
              experiences:
            </p>
