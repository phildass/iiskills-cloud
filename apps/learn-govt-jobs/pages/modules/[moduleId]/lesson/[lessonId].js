...
export default function LessonPage() {
  ...
  return (
    <>
      ...
      {showPremiumPrompt && (
        <PremiumAccessPrompt
          appName="Learn Govt Jobs"
          appHighlight="High-velocity preparation for the nation's most competitive professional exams. Access comprehensive study materials and mock tests."
