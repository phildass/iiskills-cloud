...
NEXT_PUBLIC_APP_ID=learn-govt-jobs
...
# Build the app
cd apps/learn-govt-jobs && yarn build && cd ../..
...
# Deploy with PM2
pm2 start ecosystem.config.js --only learn-govt-jobs
```
