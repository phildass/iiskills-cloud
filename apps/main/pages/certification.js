  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Learn about our certification process and requirements at iiskills.cloud"
        />
      </Head>
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          ...
          <div className="max-w-4xl mx-auto bg-white border-8 border-double border-primary p-8 md:p-12 rounded-lg shadow-2xl">
            ...
            <div className="text-center space-y-6 mb-8">
              ...
              <div className="my-6">
                <p className="text-2xl md:text-3xl font-bold text-accent">{courseName}</p>
              </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Finish all modules and learning materials in your enrolled course.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Complete the comprehensive assessment test for your course.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Achieve at least 50% marks to qualify for certification.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Get your digital certificate immediately upon passing.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-primary to-accent text-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <p className="text-lg mb-4">
            While we're proud to offer certification,{" "}
            <strong>the real value lies in the skills you master</strong>.
          </p>
          <p className="mb-4">
            Our testing process is designed to ensure genuine mastery of the subject matter, not
            just memorization. We want you to:
          </p>
          ...
          <p className="mt-4 font-semibold">
            The certificate validates your achievement, but your enhanced capabilities are what
            truly matter.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <p className="text-charcoal mb-4">
            Our assessments are carefully designed to test your understanding and practical
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              ...
              <span>
                <strong>Comprehensive Coverage:</strong> Questions span all key topics in the course
              </span>
            </li>
            <li className="flex items-start">
              <span className="text-primary mr-2">✓</span>
              <span>
                <strong>Multiple Question Types:</strong> Multiple choice, scenario-based, and
                practical questions
              </span>
            </li>
            <li className="flex items-start">
              <span className="text-primary mr-2">✓</span>
              <span>
                <strong>Fair Time Limits:</strong> Adequate time to demonstrate your knowledge
              </span>
            </li>
            <li className="flex items-start">
              <span className="text-primary mr-2">✓</span>
              <span>
                <strong>Immediate Results:</strong> Know your score and certification status
                instantly
              </span>
            </li>
            <li className="flex items-start">
              <span className="text-primary mr-2">✓</span>
              <span>
                <strong>Retake Options:</strong> Can retake the test if you don't pass on first
                attempt
              </span>
            </li>
          </ul>
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-500 p-6 rounded mb-8">
          <h2 className="text-2xl font-bold text-yellow-800 mb-4">
            ✍️ For Writing & Creative Courses
          </h2>
          <p className="text-yellow-900 mb-4">
            For practice-based courses like{" "}
            <strong>Creative Writing, Content Writing, Journalism,</strong> and{" "}
            <strong>Public Relations</strong>:
          </p>
          <div className="bg-white p-4 rounded mb-4">
            <h3 className="font-bold text-lg text-yellow-800 mb-2">
              Strong Encouragement to Practice
            </h3>
            <p className="text-gray-700 mb-3">
              We <strong>strongly encourage</strong> you to practice writing and creating original
              material <strong>without dependency on AI tools</strong>.
            </p>
          ...
          <p className="text-yellow-900 font-semibold">
            While AI tools can be helpful for editing and refinement, the core creative work should
            come from you. This is how you truly develop as a writer or content creator.
          </p>
        </div>
        ...
        <div className="text-center bg-gradient-to-r from-accent to-primary text-white rounded-lg p-8 mb-8">
          ...
          <p className="text-lg mb-6">Browse our courses and start your learning journey today!</p>
