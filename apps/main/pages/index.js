...
export default function Home() {
  ...
  return (
    <>
      ...
      <main>
        {/* HERO SECTION: keep image normal (object-position favoring top), move text down slightly */}
        <section className="relative w-full h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden">
          {/* Background image - fills hero area, object-position tuned to preserve faces */}
          ...
          {/* Reduced overlay opacity for better balance */}
          ...
          <div className="relative z-20 h-full flex items-center justify-center">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center translate-y-8 md:translate-y-12 lg:translate-y-16">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-white mb-4 leading-snug">
                Indian Institute of Professional Skills Development
              </h2>
              <p className="text-xl sm:text-2xl lg:text-3xl text-white mb-10 leading-relaxed">
