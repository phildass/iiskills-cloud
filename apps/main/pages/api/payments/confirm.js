...
import { grantBundleAccess, grantAppAccess } from "../../../../../packages/access-control";
...
export default async function handler(req, res) {
  ...
  if (supabase) {
    ...
    if (entErr) {
      ...
      // grantBundleAccess handles bundle apps (e.g. learn-ai unlocks learn-developer);
      // grantAppAccess handles standalone paid apps.
