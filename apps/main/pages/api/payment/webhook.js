/**
 * /api/payment/webhook — PAYMENT_STUB
 *
 * ── PAYMENT_STUB ─────────────────────────────────────────────────────────────
 * The payment system has been intentionally DISABLED.
 * This endpoint returns 503 for all requests.
 *
 * This endpoint previously handled Razorpay webhook notifications after
 * successful payment, verifying signatures and granting entitlements.
 *
 * When payments are re-introduced, this handler MUST be rebuilt from scratch
 * with full security review (signature verification, replay protection, etc.).
