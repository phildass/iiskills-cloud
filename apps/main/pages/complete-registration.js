        ...
        <main className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center">
            ...
            <div className="space-y-2">
              ...
              <Link href="/apps-dashboard" className="block text-sm text-gray-500 hover:text-gray-700">
                My Apps Dashboard
              </Link>
            </div>
          </div>
      ...
      <main className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {password && (
                <div className="mt-2">
                  ...
                  <p className="text-xs text-gray-500">
                    Strength:{' '}
                    <span className={`font-semibold ${strength.score >= 3 ? 'text-green-600' : 'text-orange-500'}`}>
                      {strength.label}
                    </span>
                  </p>
                </div>
            ...
            <button
              type="submit"
              disabled={submitting || pwErrors.length > 0 || !password || password !== confirmPassword}
