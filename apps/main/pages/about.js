  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Learn about iiskills.cloud and AI Cloud Enterprises' mission to democratize education in India"
        />
      </Head>
      <main className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <p className="text-lg text-charcoal leading-relaxed mb-4">
            <strong>iiskills.cloud</strong> is the digital gateway for the{" "}
            <strong>Indian Institute of Professional Skills Development</strong>, a transformative
            initiative dedicated to making quality education accessible and affordable for every
            Indian.
          </p>
          <p className="text-lg text-charcoal leading-relaxed">
            We are committed to fostering career advancement and skill certification for India's
            workforce and enterprises through innovative technology, expert instruction, and a deep
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div className="bg-gradient-to-br from-primary to-blue-700 text-white rounded-lg shadow-lg p-8">
            ...
            <p className="leading-relaxed">
              ...
              per course
              {pricing.isIntroductory ? ", inaugural offer valid from March 21, 2026 to April 20, 2026" : ""}),
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg shadow-lg p-8 mb-8">
          ...
          <p className="text-charcoal leading-relaxed mb-4">
            <strong>iiskills.cloud</strong> is a flagship project of{" "}
            <a
            ...
            , a technology company dedicated to leveraging artificial intelligence and cloud
