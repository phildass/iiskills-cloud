  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Terms and Conditions for iiskills.cloud and Indian Institute of Professional Skills Development"
        />
      </Head>
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-6">
          ...
          <section>
            ...
            <p className="text-charcoal leading-relaxed">
              You must be at least 13 years of age to use our platform. If you are under 18, you
              must have parental or guardian consent. By using our services, you represent and
            ...
            {pricing.isIntroductory && (
              <div className="bg-green-50 border-l-4 border-green-500 p-4 mb-3 rounded">
                ...
                <p className="text-green-700 text-sm">
                  Introductory fee valid till March 31, 2026. New fees will be effective from April 01,
                  2026. Current price: {pricing.totalPrice} per course. Regular price from
                  April 01, 2026: Rs 352.82 per course (Rs 299 + Rs 53.82 GST).
                </p>
              </div>
            )}
            <p className="text-charcoal leading-relaxed">
          ...
          <section>
            ...
            <p className="text-charcoal leading-relaxed">
              ...
              disputes arising out of or relating to these Terms or your use of our services shall
              be subject to the exclusive jurisdiction of the courts located in Bengaluru, India.
