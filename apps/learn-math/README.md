# Learn Math - Comprehensive AI Course Platform
...
Learn Math is a self-paced online course platform designed to take students from AI fundamentals to monetization strategies. The platform includes:
...
# Build the app
cd apps/learn-math && yarn build && cd ../..
...
# Deploy with PM2
pm2 start ecosystem.config.js --only learn-math
```
