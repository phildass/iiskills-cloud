...
export default function Curriculum() {
  ...
  return (
    <>
      <Head>
        <title>Full Curriculum - Learn Mathematics</title>
        <meta
          name="description"
          content="Complete Mathematics curriculum: 3 courses × 10 modules × 10 lessons = 300 lessons total"
        />
      </Head>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12">
            <div className="flex items-center justify-between mb-6">
              <h1 className="text-4xl font-bold">Complete Mathematics Curriculum</h1>
            ...
            <div className="card">
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li className="flex items-start">
                  <span className="font-semibold mr-2">✅</span>
                  <span>
                    <strong>Quiz After Each Lesson</strong> - Pass with 3/5 to unlock the next lesson
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="font-semibold mr-2">🎓</span>
                  <span>
                    <strong>Final Certification Exam</strong> - 20 questions, pass with 13+ correct answers
                  </span>
                </li>
              </ul>
            </div>
