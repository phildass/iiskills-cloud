...
const INTERMEDIATE_QUESTIONS = [
  {
    ...
    options: ["x = 2 only", "x = 2 or x = -2", "x = 4 or x = -4", "x = 8"],
    correctAnswer: 1,
  },
  {
...
const LEARNING_PATHS = [
  {
    ...
    emoji: "🟢",
    description:
      "Start with maths fundamentals — numbers, fractions, basic algebra, and arithmetic.",
    requiresTest: false,
  },
  {
    id: "intermediate",
  ...
  },
  {
    ...
    emoji: "🟣",
    description:
      "Master advanced maths — calculus, linear algebra, differential equations, and statistics.",
    requiresTest: true,
          ...
          <div className="container mx-auto px-4 max-w-2xl text-center">
            <div className="bg-white rounded-2xl shadow-lg p-10">
              ...
              <p className="text-lg text-gray-700 mb-6">
                ...
                path. Your Maths journey begins now!
              </p>
              <a
                href="/curriculum"
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Start Your Maths Journey</h1>
