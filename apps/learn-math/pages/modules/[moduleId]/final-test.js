...
const FINAL_TEST_QUESTIONS = {
  1: [
    ...
    {
      question: "Which set of numbers includes all integers AND fractions?",
      options: ["Natural numbers", "Whole numbers", "Rational numbers", "Prime numbers"],
      correct_answer: 2,
    },
    {
      question: "What is the result of 3/4 + 1/2?",
      options: ["4/6", "5/4", "7/8", "4/8"],
      correct_answer: 1,
    },
    { question: "What is the LCM of 4 and 6?", options: ["2", "12", "24", "8"], correct_answer: 1 },
    {
      question: "What is the GCF (HCF) of 12 and 18?",
      options: ["2", "3", "6", "9"],
      correct_answer: 2,
    },
    {
    ...
    {
      question: "What is the place value of 4 in the number 3,412?",
      options: ["Ones", "Tens", "Hundreds", "Thousands"],
      correct_answer: 2,
    },
    {
      question: "Which is the correct order of operations (BODMAS/PEMDAS)?",
      options: [
        "Left to right only",
        "Brackets/Parentheses, then Orders/Exponents, then Multiplication/Division, then Addition/Subtraction",
        "Addition before subtraction always",
        "Multiplication before brackets always",
      ],
      correct_answer: 1,
    },
    {
      question: "What is the value of 10⁰?",
      options: ["0", "10", "1", "undefined"],
      correct_answer: 2,
    },
    ...
    {
      question: "What is the difference between natural numbers and whole numbers?",
      options: [
        "They are the same set",
        "Whole numbers include 0; natural numbers start at 1",
        "Natural numbers include 0; whole numbers start at 1",
        "Whole numbers include negative integers",
      ],
      correct_answer: 1,
    },
  ],
  2: [
    ...
    },
    {
      ...
      options: ["4x + 2y", "2x + 6y", "4x + 6y", "2x + 2y"],
      correct_answer: 1,
    },
    {
      ...
      options: [
        ...
        "An equation that, when graphed, produces a straight line",
        "An equation with more than two variables",
        "An equation with absolute value signs",
      ],
      correct_answer: 1,
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        "The numerical factor multiplied by the variable in a term",
        "The exponent on a variable",
        "A constant term without a variable",
      ],
      correct_answer: 1,
    },
    { question: "Simplify: (3x²)(2x³)", options: ["6x⁵", "5x⁶", "6x⁶", "5x⁵"], correct_answer: 0 },
    {
      question: "What does it mean for two expressions to be equivalent?",
      options: [
        "They look the same",
        "They produce the same value for all values of the variable",
  ...
  3: [
    ...
    {
      question: "What theorem states that the three medians of a triangle meet at a single point?",
      options: [
        "Pythagorean theorem",
    ...
    {
      question: "If two angles in a triangle are 40° and 70°, what is the third angle?",
      options: ["60°", "70°", "80°", "110°"],
      correct_answer: 1,
    },
    {
      question: "What is congruence in geometry?",
      options: [
        "Two shapes that are similar but different sizes",
        "Two shapes that are identical in shape and size",
        "Two shapes that have the same area only",
        "Two shapes that have the same perimeter only",
      ],
      correct_answer: 1,
    },
    {
  ...
  4: [
    ...
    {
      question: "In a right triangle, cos(θ) equals:",
      options: [
        "opposite/hypotenuse",
        "adjacent/hypotenuse",
        "opposite/adjacent",
    ...
    {
      question: "In a right triangle, tan(θ) equals:",
      options: [
        "opposite/hypotenuse",
        "adjacent/hypotenuse",
        "opposite/adjacent",
    ...
    {
      question: "Convert π/4 radians to degrees.",
      options: ["30°", "45°", "60°", "90°"],
      correct_answer: 1,
    },
    {
      question: "What is the Pythagorean identity?",
      options: ["sin²θ + cos²θ = 1", "sin²θ − cos²θ = 1", "sinθ + cosθ = 1", "tanθ = sinθ − cosθ"],
      correct_answer: 0,
    },
    {
    ...
    {
      question: "Which trig function is positive in the second quadrant?",
      options: ["cos", "tan", "sin", "sec"],
      correct_answer: 2,
    },
    {
    ...
    {
      question: "What is the inverse function of sin?",
      options: ["cos", "arcsin (sin⁻¹)", "csc", "sec"],
      correct_answer: 1,
    },
    {
      question: "What is the range of arcsin?",
      options: ["[0, π]", "[−π, π]", "[−π/2, π/2]", "[0, 2π]"],
      correct_answer: 2,
    },
  ...
  5: [
    {
      ...
      options: ["y = mx + b", "ax² + bx + c = 0", "y = a(x − h)² + k", "x = (−b ± √(b²−4ac)) / 2a"],
      correct_answer: 1,
    },
    {
    ...
    },
    {
      ...
      options: ["b² − 4ac", "−b/2a", "b² + 4ac", "√(b² − 4ac)"],
      correct_answer: 0,
    },
    {
    ...
    },
    {
      ...
      options: ["x = 4 and x = −4", "x = 2 only", "x = 2 and x = −2", "x = ±4"],
      correct_answer: 2,
    },
    {
      question: "What is the vertex form of a quadratic?",
      options: ["ax² + bx + c", "y = mx + b", "y = a(x − h)² + k", "y = ax³ + bx²"],
      correct_answer: 2,
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        "A polynomial can be factored if its discriminant is positive",
      ],
      correct_answer: 0,
    },
    {
      ...
      options: [
        "Every polynomial has real roots",
        "Every polynomial of degree n > 0 has exactly n roots (counting multiplicity) in the complex numbers",
    ...
    },
    {
      ...
      options: [
        "A function with only rational coefficients",
        "A function expressed as the ratio of two polynomials P(x)/Q(x)",
        "A polynomial with rational roots",
        "A function that produces rational outputs",
      ],
      correct_answer: 1,
    },
    {
    ...
    },
    {
      ...
      options: [
        "f(x) = f(−x) for all x — symmetric about the y-axis",
        "f(−x) = −f(x) for all x — symmetric about the origin",
        "A function with an even number of roots",
        "A function with even-degree terms only",
      ],
      correct_answer: 0,
    },
    {
      ...
      options: [
        "f(x) = f(−x) for all x",
        "f(−x) = −f(x) for all x — symmetric about the origin",
        "A function with an odd number of roots",
        "A function with only odd-degree terms in its polynomial",
      ],
      correct_answer: 1,
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        "A function formed by applying one function to the output of another: (f ∘ g)(x) = f(g(x))",
        "A function that combines addition and multiplication",
        "A polynomial with complex roots",
      ],
      correct_answer: 1,
    },
    {
      question: "What is the inverse of the function f(x) = 2x + 1?",
      options: ["f⁻¹(x) = x/2 − 1", "f⁻¹(x) = (x − 1)/2", "f⁻¹(x) = 2x − 1", "f⁻¹(x) = 1/(2x+1)"],
      correct_answer: 1,
    },
  ],
  6: [
    ...
    {
      question: "Using the power rule, what is d/dx(xⁿ)?",
    ...
    {
      question: "What does the first derivative test determine?",
      options: [
        "The concavity of the function",
        "Whether a critical point is a local maximum, minimum, or neither",
    ...
    {
      question: "At a local maximum, the first derivative:",
      options: [
        "Is positive",
        "Is negative",
    ...
    },
    {
      ...
      options: [
        "Its rate of change at a point",
        "The concavity of the function (concave up if f'' > 0, concave down if f'' < 0)",
    ...
    },
    {
      ...
      options: [
        ...
        "A point where the concavity changes (f'' changes sign)",
    ...
    },
    {
      ...
      options: [
        "A point where the second derivative equals zero",
        "A point where the first derivative equals zero or is undefined",
        "The global maximum of a function",
        "An asymptote",
      ],
      correct_answer: 1,
    },
    {
      question: "What does L'Hôpital's Rule state?",
      options: [
        "If f is continuous on a closed interval, it attains its maximum and minimum",
        "If lim f/g gives 0/0 or ∞/∞, then lim f/g = lim f'/g' (under appropriate conditions)",
    ...
    },
    {
      ...
      options: [
        "All polynomials have a global minimum",
        "A continuous function on a closed interval attains both a maximum and a minimum value",
        "A function with derivative zero is constant",
  ...
  7: [
    ...
    {
      question: "What is the antiderivative (indefinite integral) of 2x?",
    ...
    },
    {
      ...
      options: [
        ...
        "If F is the antiderivative of f, then ∫ₐᵇ f(x)dx = F(b) − F(a)",
        "The derivative of an integral returns the integrand",
        "Differentiation and integration are inverse operations in general",
      ],
      correct_answer: 1,
    },
    {
      question: "What is ∫ xⁿ dx (n ≠ −1)?",
      options: ["nxⁿ⁻¹ + C", "xⁿ⁺¹/(n+1) + C", "xⁿ/n + C", "xⁿ⁺¹ + C"],
      correct_answer: 1,
    },
    {
      question: "What is ∫ eˣ dx?",
      options: ["xeˣ + C", "eˣ + C", "eˣ/x + C", "eˣ⁻¹ + C"],
      correct_answer: 1,
    },
    {
    ...
    {
      question: "What is the substitution method (u-substitution) used for?",
      options: [
        "Integrating by parts",
        "Simplifying an integral by substituting u = g(x) to apply the chain rule in reverse",
    ...
    {
      question:
        "How is the area between two curves y = f(x) and y = g(x) (where f ≥ g) on [a,b] calculated?",
      options: [
        "∫ₐᵇ f(x) dx",
        "∫ₐᵇ [f(x) + g(x)] dx",
        "∫ₐᵇ [f(x) − g(x)] dx",
    ...
    },
    {
      ...
      options: [
        "The antiderivative of a function",
        "The integral evaluated between two specific limits, producing a numeric value",
        "An integral with no limits of integration",
        "The integral of an unbounded function",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        "Volume = ∫ₐᵇ 2πx f(x) dx",
        "Volume = ∫ₐᵇ π[f(x)]² dx — rotating a region about the x-axis",
        "Volume = ∫ₐᵇ [f(x)]² dx",
        "Volume = π∫ₐᵇ f(x) dx",
      ],
      correct_answer: 1,
    ...
    {
      question: "What is a convergent improper integral?",
      options: [
        "An integral with finite limits",
        "An integral over an infinite interval (or with an infinite discontinuity) that evaluates to a finite value",
        "An integral that equals zero",
        "An integral of a decreasing function",
      ],
      correct_answer: 1,
    },
    {
      question: "What is the average value of f(x) on [a, b]?",
      options: ["f(a) + f(b) / 2", "(1/(b−a)) ∫ₐᵇ f(x) dx", "∫ₐᵇ f(x) dx / f(b)", "f((a+b)/2)"],
      correct_answer: 1,
    },
    {
      question: "What is the arc length formula for y = f(x) on [a, b]?",
      options: ["∫ₐᵇ f(x) dx", "∫ₐᵇ √(1 + [f'(x)]²) dx", "∫ₐᵇ [f(x)]² dx", "∫ₐᵇ 2πf(x) dx"],
      correct_answer: 1,
    },
    {
      ...
      options: [
        "A geometric series",
        "An infinite polynomial representation of a function based on its derivatives at a single point",
        "A series that always converges to a finite value",
        "A Fourier series variant",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        ...
        "A Taylor series centred at x = 0",
        "A series for trigonometric functions only",
        "A convergent power series",
      ],
      correct_answer: 1,
    },
    {
      question: "What does the integral ∫ₐᵇ f(x) dx represent geometrically?",
      options: [
        "The slope of f between a and b",
        "The net signed area between the curve y = f(x) and the x-axis from x = a to x = b",
    ...
    },
    {
      ...
      options: [
        "Volume = ∫ₐᵇ π[f(x)]² dx",
        "Volume = ∫ₐᵇ 2πx·f(x) dx — rotating a region about the y-axis",
        "Volume = ∫ₐᵇ [f(x) − g(x)] dx",
        "Volume = 2π∫ₐᵇ f(x) dx",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        ...
        "Breaking a rational function into simpler fractions to make integration easier",
  ...
  8: [
    {
      ...
      options: [
        "A measure of the frequency of past events",
        "A measure of the likelihood that an event will occur, between 0 and 1 inclusive",
    ...
    },
    {
      ...
      options: [
        ...
        "The middle value (or average of the two middle values) when data is sorted in order",
        "The most common value",
        "The value halfway between the minimum and maximum",
      ],
      correct_answer: 1,
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        "The average of the squared deviations from the mean, measuring data spread",
    ...
    },
    {
      ...
      options: [
        ...
        "The square root of the variance — a measure of how spread out data is around the mean",
    ...
    },
    {
      ...
      options: [
        ...
        "A symmetric bell-shaped probability distribution described by mean and standard deviation",
        "A distribution where the mean is zero",
        "A distribution used only for large datasets",
      ],
      correct_answer: 1,
    },
    {
    ...
    },
    {
      ...
      options: [
        "Events that must both occur",
        "Events that cannot occur simultaneously — P(A and B) = 0",
    ...
    },
    {
      ...
      options: [
        "P(A) × P(B)",
        "The probability of event A given that B has already occurred: P(A∩B)/P(B)",
        "P(A) + P(B) − P(A∩B)",
        "P(not B given A)",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        "A variable that changes randomly in an equation",
        "A variable whose value is determined by the outcome of a random experiment",
        "Any unknown in a statistical formula",
    ...
    },
    {
      ...
      options: [
        ...
        "The probability distribution of the number of successes in n independent trials with probability p of success each",
        "A distribution of two datasets",
    ...
    },
    {
      ...
      options: [
        ...
        "Large datasets always follow a normal distribution",
        "The median equals the mean in symmetric distributions",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        "Testing a new mathematical formula",
        "A statistical method for testing whether there is enough evidence to reject a null hypothesis",
        "Testing data quality",
        "Comparing two datasets by eye",
      ],
      correct_answer: 1,
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        "A measure of how one variable changes the other",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        ...
        "A method for modelling the linear relationship between a dependent variable and one independent variable: y = mx + b",
        "Calculating the correlation coefficient",
        "Finding the mean and variance of a dataset",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        "Any data point greater than the mean",
        "A data point that lies far from the other observations and may indicate an error or unusual occurrence",
  ...
  9: [
    ...
    },
    {
      ...
      options: [
        ...
        "A vector with more than two components",
        "A type of equation system",
      ],
      correct_answer: 1,
    },
    {
      question: "What is the dot product of vectors a and b?",
      options: [
        "A vector perpendicular to both a and b",
        "A scalar equal to |a||b|cos(θ) where θ is the angle between them",
        "The sum of a and b",
    ...
    {
      question: "When is the dot product of two non-zero vectors equal to zero?",
      options: [
        "When they are parallel",
        "When they are perpendicular (orthogonal)",
    ...
    },
    {
      ...
      options: [
        "A scalar equal to the dot product",
        "A vector perpendicular to both input vectors, with magnitude |a||b|sin(θ)",
        "The angle between two vectors",
        "The sum of components of both vectors",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        "Multiplying every element in one matrix by a scalar",
        "Combining two matrices by taking the dot products of rows from the first with columns from the second",
    ...
    },
    {
      ...
      options: [
        ...
        "A matrix equal to its own inverse",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        ...
        "A matrix A⁻¹ such that A · A⁻¹ = I (identity matrix)",
        "The matrix with negated elements",
        "The cofactor matrix",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        ...
        "When it has more rows than columns",
        "When all entries are positive",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        ...
        "A scalar λ such that Av = λv for some non-zero vector v (eigenvector)",
        "The trace of a matrix",
        "An element on the main diagonal",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        "A transformation that changes non-linear curves to lines",
        "A mapping between vector spaces that preserves addition and scalar multiplication",
        "Any function applied to a matrix",
    ...
    {
      question: "What are linearly independent vectors?",
      options: [
        "Vectors pointing in the same direction",
        "Vectors where no vector in the set can be written as a linear combination of the others",
        "Orthogonal vectors",
    ...
    },
    {
      ...
      options: [
        "The maximum value in the vector set",
        "The set of all vectors that can be written as linear combinations of the given vectors",
        "The length of the longest vector",
        "The subspace orthogonal to the vector set",
      ],
      correct_answer: 1,
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        "Solving systems of linear equations by reducing the augmented matrix to row echelon form",
        "Computing the determinant only",
    ...
    },
    {
      ...
      options: [
        "The matrix with its determinant computed",
        "The matrix obtained by flipping rows and columns (element aᵢⱼ becomes aⱼᵢ)",
    ...
    {
      question: "What is a null space (kernel) of a matrix A?",
      options: [
        "The set of all zero vectors",
        "The set of all vectors x such that Ax = 0",
        "The set of all right-hand sides Ax for all x",
        "The set of all eigenvectors of A",
      ],
      correct_answer: 1,
    },
    {
      question: "What is principal component analysis (PCA) fundamentally based on?",
      options: [
        "Fourier analysis",
        "Linear algebra — specifically eigendecomposition of the covariance matrix to find directions of maximum variance",
        "Logistic regression",
  ...
  10: [
    {
      ...
      options: [
        "An equation with two variables",
        "An equation involving a function and one or more of its derivatives with respect to a single variable",
        "A polynomial equation of high degree",
    ...
    },
    {
      ...
      options: [
        "An ODE that has only one solution",
        "An ODE that can be written as g(y) dy = f(x) dx, allowing separation of variables",
        "An ODE with constant coefficients",
        "An ODE that can be solved by substitution only",
      ],
      correct_answer: 1,
    },
    {
      question: "What is the general solution of a differential equation?",
      options: [
        "The unique solution satisfying initial conditions",
        "The family of all solutions, typically containing one or more arbitrary constants",
        "The numerical approximation of the solution",
        "The particular solution with C = 0",
      ],
      correct_answer: 1,
    },
    {
      question: "What is a first-order linear ODE?",
      options: [
        "An ODE of the form y' + P(x)y = Q(x)",
        "An ODE with one independent variable",
        "An ODE with degree 1 when graphed",
        "An ODE whose solution is a straight line",
      ],
      correct_answer: 0,
    },
    {
      ...
      options: [
        "An analytical method for solving ODEs exactly",
        "A numerical method for approximating solutions to ODEs using small step sizes",
        "A method for solving systems of linear equations",
        "A technique for computing Fourier series",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        ...
        "Finding solutions to linear ODEs with constant coefficients by substituting y = eʳˣ",
        "Solving partial differential equations",
        "Finding the particular solution of a nonhomogeneous ODE",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        "An ODE with non-integer derivatives",
        "An equation involving partial derivatives of a function of two or more variables",
        "An ODE with partial fractions",
        "A numerical approximation of an ODE",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        "Finding eigenvalues of differential operators",
        "Converting an ODE into an algebraic equation in the frequency domain, simplifying its solution",
        "Transforming a PDE into an ODE",
        "Plotting solutions of ODEs numerically",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        ...
        "A number of the form a + bi where a, b are real numbers and i = √(−1)",
        "A number with both a real and imaginary reciprocal",
        "Any irrational number",
      ],
      correct_answer: 1,
    },
    {
      question: "What is Euler's formula in complex analysis?",
      options: [
        "e^(iπ) + 1 = 0",
        "eⁱθ = cos θ + i sin θ",
        "i² = −1",
        "a + bi = r(cos θ + i sin θ) always",
      ],
      correct_answer: 1,
    },
    {
      question: "What is the modulus (absolute value) of a complex number a + bi?",
      options: ["a + b", "a − b", "√(a² + b²)", "a² + b²"],
      correct_answer: 2,
    },
    {
      question: "What is the argument (angle) of a complex number?",
      options: [
        "Its modulus",
        "The angle θ it makes with the positive real axis in the complex plane",
        "Its real part",
        "The sum of its real and imaginary parts",
      ],
      correct_answer: 1,
    },
    {
    ...
    },
    {
      ...
      options: [
        "A Taylor series for periodic functions",
        "A representation of a periodic function as a sum of sine and cosine terms",
        "A power series for exponential functions",
        "A series of complex numbers",
      ],
      correct_answer: 1,
    },
    {
      question: "What is an analytic function in complex analysis?",
      options: [
        "A function that can be differentiated in the real sense",
        "A function that is complex-differentiable throughout its domain (holomorphic)",
        "A function with a real-valued output",
        "A rational function",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        "Conditions for a complex function f = u + iv to be holomorphic: ∂u/∂x = ∂v/∂y and ∂u/∂y = −∂v/∂x",
        "Conditions for convergence of a complex series",
        "Equations governing heat flow",
        "Conditions for a function to be continuous at a point",
      ],
      correct_answer: 0,
    },
    {
      question: "What is the Residue Theorem in complex analysis?",
      options: [
        "The sum of residues equals zero for any closed contour",
        "A contour integral of an analytic function with isolated singularities equals 2πi times the sum of enclosed residues",
        "A theorem about convergence of power series",
        "A method for evaluating real integrals by Fourier transform",
      ],
      correct_answer: 1,
    },
    {
      question: "What is a Laplace equation?",
      options: [
        "A first-order linear ODE",
        "The PDE ∇²u = 0, whose solutions are called harmonic functions and describe steady-state phenomena",
        "An equation for the Laplace transform",
        "A differential equation for exponential growth",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        ...
        "A PDE describing how temperature distribution in a region evolves over time: ∂u/∂t = α∇²u",
        "An equation for chemical reaction rates",
        "A thermochemistry formula",
      ],
      correct_answer: 1,
    },
    {
      ...
      options: [
        "A differential equation used in fluid dynamics only",
        "A PDE describing wave propagation: ∂²u/∂t² = c²∇²u",
        "An equation for oscillating springs only",
        "The equation e^(iωt) = cos(ωt) + i sin(ωt)",
      ],
      correct_answer: 1,
    },
  ],
