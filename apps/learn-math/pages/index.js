...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const appImages = getLandingPageImages("math");
    setImages(appImages);
  }, []);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Build strong mathematical foundations and problem-solving skills" />
      </Head>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
              <div className="flex-1 text-center md:text-left z-10 space-y-6">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl leading-relaxed">
                  Build strong mathematical foundations and problem-solving skills
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start pt-4">
                  ...
                  <InstallApp appName="Learn Mathematics" />
                </div>
              </div>
              ...
              {images[0] && (
                <div className="flex-1 relative z-10 w-full">
                  ...
                  >
                    <Image
                      src={images[0]}
                      alt={`Learn Mathematics - Hero Image`}
                      fill
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            {images[1] && (
              <div className="flex justify-center mb-12">
                <div className="relative w-full max-w-md rounded-lg overflow-hidden shadow-xl">
                  <Image
                    src={images[1]}
                    alt={`Learn Mathematics - Features Image`}
                    width={600}
                    height={800}
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-neutral p-8 rounded-lg shadow">
                ...
                <h3 className="text-2xl font-bold text-accent mb-4">Core Mathematics</h3>
                <p className="text-charcoal leading-relaxed">
                  Comprehensive coverage of fundamental mathematical concepts and techniques.
                </p>
              </div>

              <div className="bg-neutral p-8 rounded-lg shadow">
                <div className="text-5xl mb-4">📐</div>
                <h3 className="text-2xl font-bold text-accent mb-4">Problem Solving</h3>
                <p className="text-charcoal leading-relaxed">
                  Develop analytical thinking and systematic problem-solving approaches.
                </p>
              </div>

              <div className="bg-neutral p-8 rounded-lg shadow">
                <div className="text-5xl mb-4">🧮</div>
                <h3 className="text-2xl font-bold text-accent mb-4">Applied Mathematics</h3>
                <p className="text-charcoal leading-relaxed">
                  Real-world applications and practical uses of mathematical principles.
                </p>
              </div>
            </div>
          </div>
