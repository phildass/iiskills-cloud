...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const appImages = getLandingPageImages("pr");
    setImages(appImages);
  }, []);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Master Public Relations strategies, media management, and brand building" />
      </Head>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-neutral p-8 rounded-lg shadow">
                ...
                <h3 className="text-2xl font-bold text-accent mb-4">Communication Strategy</h3>
                <p className="text-charcoal leading-relaxed">
                  Learn effective PR communication and media relations strategies.
                </p>
              </div>

              <div className="bg-neutral p-8 rounded-lg shadow">
                <div className="text-5xl mb-4">🎯</div>
                <h3 className="text-2xl font-bold text-accent mb-4">Brand Management</h3>
                <p className="text-charcoal leading-relaxed">
                  Develop skills in brand building and reputation management.
                </p>
              </div>

              <div className="bg-neutral p-8 rounded-lg shadow">
                <div className="text-5xl mb-4">📰</div>
                <h3 className="text-2xl font-bold text-accent mb-4">Media Relations</h3>
                <p className="text-charcoal leading-relaxed">
                  Master the art of working with media and creating impactful campaigns.
                </p>
              </div>
            </div>
          </div>
