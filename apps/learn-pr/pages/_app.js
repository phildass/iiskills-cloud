...
export default function App({ Component, pageProps }) {
  ...
  const subdomainSections = [
    {
      label: "Home",
      href: "/",
      description: "Welcome to Learn PR",
    },
    {
      label: "Learning Content",
      href: "/learn",
      description: "Access Public Relations learning materials",
    },
    {
      label: "Login",
      href: "/login",
  ...
  return (
    <>
      ...
      />
      <SubdomainNavbar subdomainName="Learn PR" sections={subdomainSections} />
      <Component {...pageProps} />
      <Footer />
