...
export default function Curriculum() {
  ...
  return (
    <>
      <Head>
        <title>Aptitude & Reasoning Mastery Curriculum - Learn Aptitude</title>
        <meta
          name="description"
          content="Aptitude & Reasoning Mastery: 3 courses (Basic, Intermediate, Advanced), each with 10 modules and 10 lessons."
        />
      </Head>
