          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <div className="prose prose-blue max-w-none">
              ...
              <p className="text-gray-700 mb-4">
                By accessing and using Learn Apt, you accept and agree to be bound by the terms and
                provision of this agreement.
              </p>

              <h2 className="text-2xl font-semibold text-gray-900 mt-6 mb-4">2. Use License</h2>
              <p className="text-gray-700 mb-4">
                Permission is granted to use Learn Apt for personal, non-commercial aptitude testing
              ...
              <p className="text-gray-700 mb-4">
                Learn Apt is provided as a free service. We reserve the right to modify or
                discontinue the service at any time.
              </p>

              <h2 className="text-2xl font-semibold text-gray-900 mt-6 mb-4">5. Disclaimer</h2>
              <p className="text-gray-700 mb-4">
                The materials on Learn Apt are provided on an 'as is' basis. We make no warranties,
              ...
              <p className="text-gray-700 mb-4">
                In no event shall Learn Apt or its suppliers be liable for any damages arising out
                of the use or inability to use the materials on Learn Apt.
              </p>
            </div>
