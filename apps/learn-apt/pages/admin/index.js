...
export default function AdminPanel() {
  ...
  const testSections = [
    {
      id: "numerical",
      title: COGNITIVE_DOMAINS.NUMERICAL,
      questionCount: (QUESTION_BANK.numerical || []).length,
    },
    {
      id: "logical",
      title: COGNITIVE_DOMAINS.LOGICAL,
      questionCount: (QUESTION_BANK.logical || []).length,
    },
    {
      id: "verbal",
      title: COGNITIVE_DOMAINS.VERBAL,
      questionCount: (QUESTION_BANK.verbal || []).length,
    },
    {
      id: "spatial",
      title: COGNITIVE_DOMAINS.SPATIAL,
      questionCount: (QUESTION_BANK.spatial || []).length,
    },
    {
      id: "dataInterpretation",
      title: COGNITIVE_DOMAINS.DATA_INTERPRETATION,
      questionCount: (QUESTION_BANK.dataInterpretation || []).length,
    },
  ];
