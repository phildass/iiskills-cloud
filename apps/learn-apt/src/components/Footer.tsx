      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Discover your learning preferences and aptitude</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="https://iiskills.cloud" className="text-gray-600 hover:text-primary">
                  Main Site
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link
                  href="https://iiskills.cloud/privacy"
                  className="text-gray-600 hover:text-primary"
                >
                  Privacy Policy
                </Link>
        ...
        <div className="border-t border-gray-300 pt-6 text-center">
          ...
          <p className="text-gray-600 text-sm mb-2">
            © {currentYear} AI Cloud Enterprises | Indian Institute of Professional Skills
            Development
          </p>
