  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Web Developer Bootcamp: 3 courses (Basic, Intermediate, Advanced), each with 10 modules and 10 lessons."
        />
      </Head>
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto mb-10">
            <h1 className="text-4xl font-bold mb-3">Web Developer Bootcamp Curriculum</h1>
