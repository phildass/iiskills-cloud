...
const ADVANCED_QUESTIONS = [
  ...
  {
    question:
      "Which pattern is commonly used to decouple microservices and enable asynchronous communication?",
    options: [
...
const LEARNING_PATHS = [
  {
    ...
    emoji: "🟢",
    description:
      "Start with developer fundamentals — HTML/CSS, Git, basic JavaScript, and web concepts.",
    requiresTest: false,
  },
  {
    id: "intermediate",
    ...
    emoji: "🔵",
    description:
      "Apply developer skills — REST APIs, databases, JavaScript frameworks, and version control.",
    requiresTest: true,
  ...
  },
  {
    ...
    emoji: "🟣",
    description:
      "Master full-stack production — system design, microservices, CI/CD, and scalable architecture.",
    requiresTest: true,
          ...
          <div className="container mx-auto px-4 max-w-2xl text-center">
            <div className="bg-white rounded-2xl shadow-lg p-10">
              ...
              <p className="text-lg text-gray-700 mb-6">
                ...
                path. Your Developer journey begins now!
              </p>
              <a
                href="/curriculum"
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Choose your Developer learning path and start your journey"
        />
      </Head>
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Start Your Developer Journey</h1>
