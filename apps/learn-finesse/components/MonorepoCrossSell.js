    ...
    <div className="py-20 px-4 bg-gradient-to-b from-gray-900 via-slate-900 to-gray-900 border-t border-gray-800">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-5xl md:text-6xl font-serif text-white mb-6">Complete Mastery</h2>

          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Master the System. Master the People. Combine{" "}
            <span className="text-blue-400 font-semibold">Learn Management</span> (The Process) with{" "}
            <span className="text-amber-400 font-semibold">Learn Finesse</span> (The People) for
            unified leadership.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {BUNDLE_APPS.map((app, index) => (
            ...
            >
              <div
                className={`w-16 h-16 rounded-xl bg-gradient-to-br ${app.color} flex items-center justify-center text-3xl mb-4 group-hover:scale-110 transition-transform duration-300`}
              >
                {app.icon}
              </div>

              <h3 className="text-2xl font-serif text-white mb-3">{app.name}</h3>
        ...
        >
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-2xl font-serif text-amber-400 mb-4">Why Bundle?</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <span className="text-amber-400 text-xl">→</span>
                  <span className="text-gray-300">
                    <span className="font-semibold">Holistic Leadership:</span> Technical + Social
                    mastery
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-amber-400 text-xl">→</span>
                  <span className="text-gray-300">
                    <span className="font-semibold">Unified Profile:</span> Showcase complete
                    competency
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-amber-400 text-xl">→</span>
                  <span className="text-gray-300">
                    <span className="font-semibold">Career Acceleration:</span> Stand out in
                    competitive markets
                  </span>
                </li>
              </ul>
            ...
            <div>
              <h3 className="text-2xl font-serif text-amber-400 mb-4">The Complete Leader</h3>
              <p className="text-gray-300 leading-relaxed mb-4">
                Management gives you the frameworks. Developer gives you the craft. Finesse gives
                you the influence.
              </p>
              <p className="text-gray-300 leading-relaxed">
                Together, they create the modern executive:{" "}
                <span className="italic">
                  technically fluent, strategically sharp, and socially commanding
                </span>
                .
              </p>
            </div>
