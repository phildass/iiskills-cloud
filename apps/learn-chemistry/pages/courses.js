...
export default function Courses() {
  return (
    <>
      <Head>
        <title>Courses — Learn Chemistry</title>
        <meta
          name="description"
          content="Choose from 3 structured courses: Basic, Intermediate, and Advanced Chemistry. Each course contains 10 modules and 100 lessons."
        />
      </Head>
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Chemistry Courses</h1>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Three structured courses — from foundational knowledge to expert-level mastery. Each
              course contains <strong>10 modules</strong> and <strong>100 lessons</strong>.
            </p>
