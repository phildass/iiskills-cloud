...
export default function Onboarding() {
  ...
  if (step === 'success') {
    return (
      <>
        <Head>
          <title>Welcome - Learn Physics</title>
        </Head>
        <main className="min-h-screen bg-gray-50 py-12">
          <div className="container mx-auto px-4 max-w-2xl text-center">
            <div className="bg-white rounded-2xl shadow-lg p-10">
              ...
              <a
                href="/curriculum"
                className="inline-block bg-gradient-to-r from-blue-700 to-blue-900 text-white px-8 py-4 rounded-lg font-bold text-lg hover:opacity-90 transition shadow-lg"
              >
                Go to Curriculum →
              </a>
            </div>
  ...
  if (step === 'otp') {
    return (
      <>
        <Head>
          <title>Enter OTP - Learn Physics</title>
        </Head>
        <main className="min-h-screen bg-gray-50 py-12">
  ...
  if (step === 'payment') {
    ...
    return (
      <>
        <Head>
          <title>Proceed to Payment - Learn Physics</title>
        </Head>
        <main className="min-h-screen bg-gray-50 py-12">
          <div className="container mx-auto px-4 max-w-md">
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-700 to-blue-900 text-white py-4 rounded-lg font-bold text-lg hover:opacity-90 transition shadow-lg mb-3"
              >
                💳 Proceed to Payment
              </button>
              <button
  ...
  if (step === 'test' && selectedPath) {
    ...
    return (
      <>
        <Head>
          <title>{selectedPath.title} Test - Learn Physics</title>
        </Head>
        <main className="min-h-screen bg-gray-50 py-12">
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {LEARNING_PATHS.map((path) => (
              <div
                key={path.id}
                className="bg-white rounded-2xl shadow-md p-6 border-2 border-gray-200 hover:border-blue-500 hover:shadow-lg transition-all cursor-pointer"
