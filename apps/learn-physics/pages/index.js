...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const appImages = getLandingPageImages("physics");
    setImages(appImages);
  }, []);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Understand the fundamental laws of nature and physical phenomena" />
      </Head>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
              <div className="flex-1 text-center md:text-left z-10 space-y-6">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl leading-relaxed">
                  Understand the fundamental laws of nature and physical phenomena
                </p>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            {images[1] && (
              <div className="flex justify-center mb-12">
                <div className="relative w-full max-w-md rounded-lg overflow-hidden shadow-xl">
                  <Image
                    src={images[1]}
                    alt={`Learn Physics - Features Image`}
                    width={600}
                    height={800}
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-neutral p-8 rounded-lg shadow">
                ...
                <h3 className="text-2xl font-bold text-accent mb-4">Core Physics</h3>
                <p className="text-charcoal leading-relaxed">
                  Master fundamental physics principles from mechanics to modern physics.
                </p>
              </div>

              <div className="bg-neutral p-8 rounded-lg shadow">
                <div className="text-5xl mb-4">🔭</div>
                <h3 className="text-2xl font-bold text-accent mb-4">Practical Understanding</h3>
                <p className="text-charcoal leading-relaxed">
                  Connect theory with real-world applications and experiments.
                </p>
              </div>
              ...
              <div className="bg-neutral p-8 rounded-lg shadow">
                ...
                <p className="text-charcoal leading-relaxed">
                  Develop analytical skills through comprehensive problem-solving practice.
                </p>
              </div>
            </div>
          </div>
