...
/**
 * Registration Page for Learn-Cricket
 *
...
export default function Register() {
  return (
    <>
      <Head>
        <title>Register - Cricket Know-All</title>
        <meta
          name="description"
          content="Create your account - Access Cricket Know-All and all iiskills.cloud apps"
        />
      </Head>
