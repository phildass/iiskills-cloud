...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const appImages = getLandingPageImages("cricket");
    setImages(appImages);
  }, []);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Your free cricket knowledge and games portal—quizzes, stats, history, events, and more!" />
      </Head>
              ...
              {images[0] && (
                <div className="flex-1 relative z-10 w-full">
                  ...
                  >
                    <Image
                      src={images[0]}
                      alt={`Cricket Know-All - Hero Image`}
                      fill
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            {images[1] && (
              <div className="flex justify-center mb-12">
                <div className="relative w-full max-w-md rounded-lg overflow-hidden shadow-xl">
                  <Image
                    src={images[1]}
                    alt={`Cricket Know-All - Features Image`}
                    width={600}
                    height={800}
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-neutral p-8 rounded-lg shadow">
                ...
                <h3 className="text-2xl font-bold text-accent mb-4">Cricket Knowledge</h3>
              ...
              <div className="bg-neutral p-8 rounded-lg shadow">
                <div className="text-5xl mb-4">📊</div>
                <h3 className="text-2xl font-bold text-accent mb-4">Games & Quizzes</h3>
                <p className="text-charcoal leading-relaxed">
              ...
              <div className="bg-neutral p-8 rounded-lg shadow">
                <div className="text-5xl mb-4">🏆</div>
                <h3 className="text-2xl font-bold text-accent mb-4">Stats & History</h3>
                <p className="text-charcoal leading-relaxed">
