...
export async function getStaticProps({ params }) {
  ...
  // 1. Try filesystem content (packages/content/learn-management/)
  const fsLesson = loader.getLesson("learn-management", moduleId, lessonId);
  if (fsLesson) {
...
export default function LessonPage({ lesson, moduleId, lessonId }) {
  ...
  const { entitled, hasAccess, loading } = useUserAccess("learn-management", {
