...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const appImages = getLandingPageImages("management");
    setImages(appImages);
  }, []);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Master business management principles and practices for career advancement" />
      </Head>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
              <div className="flex-1 text-center md:text-left z-10 space-y-6">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl leading-relaxed">
                  Master business management principles and practices for career advancement
                </p>
              ...
              {images[0] && (
                <div className="flex-1 relative z-10 w-full">
                  ...
                  >
                    <Image
                      src={images[0]}
                      alt={`Learn Management - Hero Image`}
                      fill
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            {images[1] && (
              <div className="flex justify-center mb-12">
                <div className="relative w-full max-w-md rounded-lg overflow-hidden shadow-xl">
                  <Image
                    src={images[1]}
                    alt={`Learn Management - Features Image`}
                    width={600}
                    height={800}
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-neutral p-8 rounded-lg shadow">
                ...
                <h3 className="text-2xl font-bold text-accent mb-4">Business Fundamentals</h3>
                <p className="text-charcoal leading-relaxed">
                  Core management principles and business administration concepts.
                </p>
              </div>

              <div className="bg-neutral p-8 rounded-lg shadow">
                <div className="text-5xl mb-4">📊</div>
                <h3 className="text-2xl font-bold text-accent mb-4">Operations Management</h3>
                <p className="text-charcoal leading-relaxed">
                  Learn to optimize processes, resources, and organizational efficiency.
                </p>
              </div>

              <div className="bg-neutral p-8 rounded-lg shadow">
                <div className="text-5xl mb-4">🎯</div>
                <h3 className="text-2xl font-bold text-accent mb-4">Strategic Management</h3>
                <p className="text-charcoal leading-relaxed">
                  Develop skills in planning, organizing, and executing business strategies.
                </p>
              </div>
            </div>
          </div>
