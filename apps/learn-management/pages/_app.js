...
import { AdminWrapper } from "@iiskills/ui";

const ADMIN_API_BASE = process.env.NEXT_PUBLIC_MAIN_APP_URL || "";

export default function App({ Component, pageProps }) {
  return (
    <AdminWrapper adminApiBase={ADMIN_API_BASE}>
      <>
        <Head>
        ...
        <SiteHeader appId="learn-management" isFreeApp={true} />
        <AppSecondaryNavbar appId="learn-management" appName="Management" isFree={true} />
        <Component {...pageProps} />
        <Footer />
      </>
    </AdminWrapper>
