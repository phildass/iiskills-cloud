...
const INTERMEDIATE_QUESTIONS = [
  ...
  {
    question:
      "Which leadership style is most effective when team members are highly skilled and motivated?",
    options: [
...
const LEARNING_PATHS = [
  {
    ...
    emoji: "🟢",
    description:
      "Start with management fundamentals — organisational structure, planning, and team basics.",
    requiresTest: false,
  },
  {
    id: "intermediate",
    ...
    emoji: "🔵",
    description:
      "Apply management concepts to Agile, KPIs, leadership styles, and project delivery.",
    requiresTest: true,
  ...
  },
  {
    ...
    emoji: "🟣",
    description:
      "Master strategic management, competitive analysis, change management, and executive leadership.",
    requiresTest: true,
          ...
          <div className="container mx-auto px-4 max-w-2xl text-center">
            <div className="bg-white rounded-2xl shadow-lg p-10">
              ...
              <p className="text-lg text-gray-700 mb-6">
                ...
                path. Your Management journey begins now!
              </p>
              <a
                href="/curriculum"
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Choose your Management learning path and start your journey"
        />
      </Head>
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Start Your Management Journey</h1>
