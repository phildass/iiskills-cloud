# Learn Management - Comprehensive AI Course Platform
...
Learn Management is a self-paced online course platform designed to take students from AI fundamentals to monetization strategies. The platform includes:
...
NEXT_PUBLIC_APP_ID=learn-management
...
# Build the app
cd apps/learn-management && yarn build && cd ../..
...
# Deploy with PM2
pm2 start ecosystem.config.js --only learn-management
```
