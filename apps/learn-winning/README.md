# Learn Winning - Comprehensive AI Course Platform
...
Learn Winning is a self-paced online course platform designed to take students from AI fundamentals to monetization strategies. The platform includes:
...
The app will be available at `http://localhost:3022`
...
NEXT_PUBLIC_APP_ID=learn-winning
...
# Build the app
cd apps/learn-winning && yarn build && cd ../..
...
# Deploy with PM2
pm2 start ecosystem.config.js --only learn-winning
```
