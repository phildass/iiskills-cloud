                ...
                return (
                  ...
                  >
                    <div className="text-center mb-4">
                      ...
                      <h3 className={`text-2xl font-bold mb-2 ${selectedLevel === index ? 'text-white' : 'text-primary'}`}>
                        {level.name}
                      </h3>
                      <p className={`text-sm ${selectedLevel === index ? 'text-blue-100' : 'text-gray-600'}`}>
                        {level.description}
                      </p>
                    </div>
                    ...
                    <div className="mt-4">
                      <div className="flex justify-between text-sm mb-2">
                        <span className={selectedLevel === index ? 'text-blue-100' : 'text-gray-600'}>
                          Progress
                        </span>
                        <span className={`font-bold ${selectedLevel === index ? 'text-white' : 'text-primary'}`}>
                          {progress}%
                        </span>
                      </div>
                      <div className={`w-full h-3 rounded-full ${selectedLevel === index ? 'bg-blue-200' : 'bg-gray-200'}`}>
                        <div
                    ...
                    <div className={`mt-4 text-center text-sm ${selectedLevel === index ? 'text-blue-100' : 'text-gray-600'}`}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {currentLevel.modules.map((module, modIndex) => {
                ...
                return (
                  ...
                  >
                    <h3 className={`text-xl font-bold mb-3 ${selectedModule === modIndex ? 'text-white' : 'text-primary'}`}>
                      Module {modIndex + 1}: {module.name}
                    </h3>
                    
                    <div className="mb-4">
                      <div className="flex justify-between text-sm mb-2">
                        <span className={selectedModule === modIndex ? 'text-purple-100' : 'text-gray-600'}>
                          {completedLessons}/{module.lessons.length} Lessons
                        </span>
                        <span className={`font-bold ${selectedModule === modIndex ? 'text-white' : 'text-accent'}`}>
                          {moduleProgress}%
                        </span>
                      </div>
                      <div className={`w-full h-2 rounded-full ${selectedModule === modIndex ? 'bg-purple-200' : 'bg-gray-200'}`}>
                        <div
                    ...
                    {module.testAvailable && (
                      <div className={`text-sm ${selectedModule === modIndex ? 'text-purple-100' : 'text-gray-600'}`}>
                        ✓ Test Available
                      </div>
                    )}
                  </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              {currentLevel.modules[selectedModule].testAvailable && (
                <div className="mt-8 p-6 bg-gradient-to-r from-accent to-purple-600 text-white rounded-lg">
                  ...
                  <p className="mb-4">
                    Test your knowledge of {currentLevel.modules[selectedModule].name} with an AI-generated assessment.
                  </p>
