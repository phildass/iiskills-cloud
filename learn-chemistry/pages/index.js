  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Master chemistry concepts, chemical reactions, and advance your scientific knowledge through AI-driven learning"
        />
      </Head>
        ...
        <section className="relative bg-gradient-to-r from-primary to-blue-600 text-white py-20">
          <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            <p className="text-2xl mb-8 max-w-3xl mx-auto">
              Master chemistry concepts, chemical reactions, and advance your scientific knowledge
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-neutral p-8 rounded-lg shadow-lg">
                ...
                <p className="text-charcoal">
                  Experience AI-generated lessons, quizzes, and tests tailored to your learning
                  pace.
                </p>
              </div>
              ...
              <div className="bg-neutral p-8 rounded-lg shadow-lg">
                ...
                <p className="text-charcoal">
                  Monitor your journey through tiered progress visualization and achievement
                  tracking.
                </p>
              </div>
            </div>
