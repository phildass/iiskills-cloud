...
export async function getCurrentUser() {
  ...
  try {
    ...
    if (isAuthDisabled) {
      console.log("⚠️ AUTH DISABLED [learn-govt-jobs]: Returning mock user");
      return {
        id: 'dev-override-govtjobs',
...
export function getSiteUrl() {
  return (
    ...
    (typeof window !== "undefined" ? window.location.origin : "http://localhost:3013")
  );
}
