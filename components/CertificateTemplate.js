  ...
  useEffect(() => {
    if (qrCodeData && typeof window !== 'undefined') {
      import('qrcode').then(QRCode => {
        QRCode.default.toDataURL(qrCodeData, { width: 120, margin: 1 })
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Certificate Body */}
        <div className="text-center flex-1 flex flex-col justify-center" style={{ marginTop: '-20px', marginBottom: '-20px' }}>
        ...
        <div style={{ marginTop: 'auto' }}>
          ...
          <div className="flex justify-between items-end mb-6 pb-4" style={{ borderTop: '2px solid #e5e7eb', paddingTop: '20px' }}>
          ...
          <div className="flex justify-around items-end">
            <div className="text-center">
              ...
              >
                <p className="font-bold" style={{ fontSize: '16px', color: '#111827', fontFamily: 'Georgia, serif' }}>Pradhyot Kumar</p>
            ...
            <div className="text-center">
              ...
              >
                <p className="font-bold" style={{ fontSize: '16px', color: '#111827', fontFamily: 'Georgia, serif' }}>Academic Head</p>
