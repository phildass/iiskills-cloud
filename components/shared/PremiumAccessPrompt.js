 ...
 * Shows after successful sample lesson/test completion
 *
 * Pricing is sourced from the centralized utils/pricing.js module.
 * AI-Dev bundle offer (buy one get one): valid until March 31, 2026.
 */
...
export default function PremiumAccessPrompt({ 
  ...
  const bundleNotice = showAIDevBundle ? getBundleOfferNotice() : null;
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
      <div className="bg-white rounded-2xl max-w-xl w-full p-8 shadow-2xl overflow-y-auto max-h-screen">
        ...
        {/* Fee Structure — sourced from centralized pricing module */}
