...
const SAMPLE_CONTENT = {
  math: {
    ...
    summary:
      "This is your entry point to mathematical mastery. Sample lessons and diagnostics are available to preview the real course progression.",
    lesson: {
      title: "Foundations of Algebra",
      intro:
        "Algebra is the language of mathematics. In this introductory lesson, you'll learn how variables, constants, and operations work together to solve real-world problems.",
      concepts: [
      ...
      example: {
        ...
        explanation:
          "We isolate the variable by performing inverse operations on both sides of the equation.",
      },
    },
    test: {
  ...
  physics: {
    ...
    summary:
      "Discover the laws that govern our universe. Sample lessons explore fundamental physics concepts with real-world applications.",
    lesson: {
      title: "Newton's Laws of Motion",
      intro:
        "Sir Isaac Newton's three laws of motion form the foundation of classical mechanics. These principles explain how objects move and interact.",
      concepts: [
    ...
    test: {
      ...
      correctAnswer: 2,
      explanation:
        "Newton's Third Law: For every action, there is an equal and opposite reaction. The wall pushes back with 100N.",
    },
  },
  chemistry: {
    headline: "Welcome to Learn Chemistry!",
    summary:
      "Explore the molecular world. Sample lessons introduce you to atoms, bonds, and chemical reactions.",
    lesson: {
      title: "Introduction to Chemical Bonding",
      intro:
        "Chemical bonds are the forces that hold atoms together. Understanding bonding is key to predicting molecular properties and reactions.",
      concepts: [
      ...
      example: {
        ...
        solution: "Ionic bond",
        explanation:
          "Sodium (Na) donates an electron to Chlorine (Cl), creating oppositely charged ions that attract.",
      },
    },
    test: {
  ...
  biology: {
    ...
    summary:
      "Decode the ingredients of life. Sample lessons explore cells, genetics, and living systems.",
    lesson: {
      title: "Cell Structure and Function",
      intro:
        "Cells are the basic units of life. From bacteria to humans, all organisms are made of cells with specialized structures.",
      concepts: [
      ...
      example: {
        ...
        explanation:
          "Mitochondria convert glucose and oxygen into ATP, the energy currency of cells.",
      },
    },
    test: {
  ...
  geography: {
    ...
    summary:
      "Understand our planet Earth. Sample lessons cover landforms, climate, and human-environment interactions.",
    lesson: {
      title: "Plate Tectonics and Earthquakes",
      intro:
        "Earth's crust is divided into tectonic plates that slowly move, causing earthquakes, volcanoes, and mountain formation.",
      concepts: [
      ...
      example: {
        ...
        explanation:
          "When plates slide past, collide, or separate, they release energy as seismic waves.",
      },
    },
    test: {
      ...
      correctAnswer: 1,
      explanation:
        "Convergent boundaries, where plates collide, push up mountain ranges like the Himalayas.",
    },
  },
  aptitude: {
    headline: "Welcome to Learn Aptitude!",
    summary:
      "Sharpen your logical thinking. Sample diagnostics test reasoning, quantitative, and verbal skills.",
    lesson: {
      title: "Logical Reasoning Fundamentals",
      intro:
        "Logical reasoning helps you identify patterns, make deductions, and solve problems systematically.",
      concepts: [
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-3">{content.headline}</h1>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">{content.summary}</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border border-purple-200">
              ...
              <p className="text-gray-600 text-sm">Challenge yourself with qualifying questions</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-md border border-green-200">
              ...
              <p className="text-gray-600 text-sm">Map your strengths and areas for growth</p>
            </div>
          </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        >
          <div className="text-center mb-6">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-2">Sample Diagnostic Question</h2>
            <p className="text-gray-600">{appName} Qualifying Test</p>
          </div>

          <div className="bg-gray-50 rounded-xl p-6 mb-6">
            <p className="text-xl text-gray-900 font-medium">{content.test.question}</p>
          </div>
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      >
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{content.lesson.title}</h1>
          <p className="text-lg text-gray-700">{content.lesson.intro}</p>
        </div>
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded mb-8">
          <p className="text-yellow-800 text-sm">
            <strong>📌 Sample Content:</strong> This is AI-generated educational content to preview
            the course structure. Full lessons with interactive elements are coming soon.
          </p>
        </div>
