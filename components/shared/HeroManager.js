...
/**
 * HeroManager:
 * - Selects two images for a workspace (random from /public/images by default)
 * - For learn-cricket: uses cricket1.jpg, cricket2.jpg
...
export function getHeroImagesForApp(appId) {
  ...
  // For other apps, randomly select 2 images from the pool
