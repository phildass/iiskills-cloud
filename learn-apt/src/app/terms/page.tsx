...
export const metadata: Metadata = {
  ...
  description:
    "Terms and Conditions for Learn Aptitude and Indian Institute of Professional Skills Development",
};
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 space-y-6">
        <section>
          ...
          <p className="text-charcoal leading-relaxed">
            ...
            ("IISKILLS," "we," "us," or "our"). By accessing or using our platform, you agree to be
        ...
        <section>
          ...
          <p className="text-charcoal leading-relaxed">
            ...
            iiskills.cloud, you acknowledge that you have read, understood, and agree to these Terms
            and our Privacy Policy. These Terms constitute a legally binding agreement between you
            and IISKILLS.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-charcoal leading-relaxed">
            You must be at least 13 years of age to use our platform. If you are under 18, you must
            have parental or guardian consent. By using our services, you represent and warrant that
        ...
        <section>
          ...
          <p className="text-charcoal leading-relaxed mb-3">
            Our courses are currently priced at {pricing.totalPrice} per course ({pricing.basePrice}{" "}
            + {pricing.gstRate} GST). All fees are in Indian Rupees (INR) and must be paid in full
          ...
          <p className="text-charcoal leading-relaxed">
            Payments are processed through secure third-party payment gateways. By providing payment
            information, you authorize us to charge the applicable fees. We do not store your
          ...
          <p className="text-charcoal leading-relaxed">
            ...
            are final. Refunds are provided only in cases of technical errors that prevent access to
            course content, at our sole discretion. Refund requests must be submitted within 7 days
            of purchase to{" "}
        ...
        <section>
          ...
          <p className="text-charcoal leading-relaxed">
            We strive to provide continuous access to purchased courses, but we reserve the right to
            modify, update, or discontinue courses at any time. We will make reasonable efforts to
        ...
        <section>
          ...
          <p className="text-charcoal leading-relaxed">
            ...
            development. IISKILLS does not guarantee recognition of our certificates by third-party
        ...
        <section>
          ...
          <p className="text-charcoal leading-relaxed mt-2">
            Violation of these conduct rules may result in immediate account suspension or
            termination.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-charcoal leading-relaxed">
            ...
            legal fees) arising out of or in any way connected with your use of our services, your
        ...
        <section>
          ...
          <p className="text-charcoal leading-relaxed">
            ...
            practices of these third parties. Your use of third-party services is at your own risk
        ...
        <section>
          ...
          <p className="text-charcoal leading-relaxed">
            ...
            any time, with or without cause, and with or without notice, for any reason, including
            violation of these Terms. Upon termination, your right to use the platform will
        ...
        <section>
          ...
          <p className="text-charcoal leading-relaxed">
            ...
            disputes arising out of or relating to these Terms or your use of our services shall be
            subject to the exclusive jurisdiction of the courts located in Bengaluru, India. You
        ...
        <section>
          ...
          <p className="text-charcoal leading-relaxed">
            ...
            posting the updated Terms on this page with a revised "Last Updated" date. Your
        ...
        <section>
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            <p className="text-charcoal">
              <strong>Indian Institute of Professional Skills Development (IISKILLS)</strong>
            </p>
            <p className="text-charcoal">
              Email:{" "}
              <a href="mailto:info@iiskills.cloud" className="text-primary hover:underline">
            ...
            <p className="text-charcoal">
              Website:{" "}
              <a href="https://iiskills.cloud" className="text-primary hover:underline">
        ...
        <section className="border-t pt-6 mt-6">
          <p className="text-charcoal leading-relaxed italic">
            By using iiskills.cloud, you acknowledge that you have read, understood, and agree to be
