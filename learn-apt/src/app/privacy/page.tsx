...
export const metadata: Metadata = {
  title: "Privacy Policy - Learn Aptitude",
  description:
    "Privacy Policy for Learn Aptitude and Indian Institute of Professional Skills Development",
};
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 space-y-6">
        <section>
          ...
          <p className="text-charcoal leading-relaxed">
            Welcome to iiskills.cloud, the digital learning platform of the Indian Institute of
            Professional Skills Development ("IISKILLS," "we," "us," or "our"). This Privacy Policy
            explains how we collect, use, disclose, and safeguard your information when you visit
            our website and use our services. By accessing or using iiskills.cloud, you agree to
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-charcoal space-y-1 ml-4">
            <li>
              ...
              platform (e.g., payment processors, hosting services, analytics providers). These
              providers are contractually obligated to protect your data.
            </li>
            <li>
              <strong>Legal Compliance:</strong> When required by law, regulation, or legal process,
        ...
        <section>
          ...
          <p className="text-charcoal leading-relaxed">
            ...
            no internet-based service is completely secure, and we cannot guarantee absolute
            security.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-charcoal leading-relaxed">
            ...
            but disabling cookies may limit certain features of our platform.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-charcoal space-y-1 ml-4">
            ...
            <li>
              <strong>Deletion:</strong> Request that we delete your personal information, subject
        ...
        <section className="border-t pt-6 mt-6">
          <p className="text-charcoal leading-relaxed italic">
            By using iiskills.cloud, you acknowledge that you have read and understood this Privacy
