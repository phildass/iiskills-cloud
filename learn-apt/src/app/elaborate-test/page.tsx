...
const modules: Module[] = [
  ...
  // -------- next: verbal-reasoning etc. --------
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { value: "a", label: "A) Hopeful" },
          { value: "b", label: "B) Pessimistic" },
          { value: "c", label: "C) Confident" },
      ...
      {
        id: "vr3",
        text: "Complete the analogy: Pen is to Writing as Brush is to:",
        options: [
          { value: "a", label: "A) Drawing" },
          { value: "b", label: "B) Painting" },
          { value: "c", label: "C) Reading" },
      ...
      },
      {
        ...
        options: [
          { value: "a", label: "A) Apple" },
          { value: "b", label: "B) Orange" },
          { value: "c", label: "C) Banana" },
          { value: "d", label: "D) Carrot" },
          { value: "e", label: "E) I don't know" },
        ],
      },
      {
        id: "vr5",
        text: "The word 'BANK' can mean a financial institution or the side of a river. This is an example of:",
        options: [
      ...
      },
      {
        ...
        options: [
          { value: "a", label: "A) Neither of the boys are coming" },
          { value: "b", label: "B) Neither of the boys is coming" },
          { value: "c", label: "C) Neither of the boy are coming" },
          { value: "d", label: "D) Neither of the boy is coming" },
          { value: "e", label: "E) I don't know" },
        ],
      },
      {
        id: "vr7",
        text: "What is the main purpose of a narrative essay?",
        options: [
          { value: "a", label: "A) To inform" },
          { value: "b", label: "B) To tell a story" },
          { value: "c", label: "C) To persuade" },
          { value: "d", label: "D) To analyze" },
          { value: "e", label: "E) I don't know" },
        ],
      },
      {
        id: "vr8",
        text: "In the sentence 'The dog chased the ball quickly', what is 'quickly'?",
        options: [
          { value: "a", label: "A) Noun" },
          { value: "b", label: "B) Verb" },
          { value: "c", label: "C) Adjective" },
          { value: "d", label: "D) Adverb" },
          { value: "e", label: "E) I don't know" },
        ],
      },
      {
        id: "vr9",
        text: "Which literary device is used: 'The wind whispered through the trees'?",
        options: [
      ...
      {
        id: "vr10",
        text: "What does the prefix 'anti-' mean?",
        options: [
          { value: "a", label: "A) For" },
          { value: "b", label: "B) Against" },
          { value: "c", label: "C) Before" },
          { value: "d", label: "D) After" },
          { value: "e", label: "E) I don't know" },
        ],
      },
    ],
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: "ci10",
        text: "When evaluating creative ideas, I prioritize:",
        options: [
          { value: "a", label: "Originality and uniqueness" },
          { value: "b", label: "Practicality and feasibility" },
          { value: "c", label: "Impact and value" },
          { value: "d", label: "Simplicity and elegance" },
        ],
      },
    ],
  },
...
export default function ElaborateTestPage() {
  ...
  const handleSelectAnswer = useCallback(
    ...
    [currentQuestion, currentQuestionIndex, currentModuleIndex, currentModule, handleSubmit]
  );
