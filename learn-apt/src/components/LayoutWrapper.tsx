      ...
      <SharedNavbar
        ...
        customLinks={[
          ...
          { href: "/admin", label: "Sign In", className: "hover:text-primary transition" },
          {
            ...
            label: "Register",
            className:
              "bg-primary text-white px-4 py-2 rounded hover:bg-blue-700 transition font-bold",
            mobileClassName:
              "block bg-primary text-white px-4 py-2 rounded hover:bg-blue-700 transition font-bold",
          },
        ]}
      />
