    ...
    modules: [
      {
        ...
        description: "Master logical puzzles and pattern recognition",
        difficulty: "Beginner",
        order: 1,
        lesson_count: 10,
      },
      {
        ...
        description: "Develop strong mathematical problem-solving skills",
        difficulty: "Beginner",
        order: 2,
        lesson_count: 10,
      },
      {
        ...
        description: "Enhance vocabulary and comprehension abilities",
        difficulty: "Beginner",
        order: 3,
        lesson_count: 10,
      },
      ...
      },
      {
        ...
        description: "Master pattern recognition and spatial reasoning",
        difficulty: "Advanced",
        order: 7,
        lesson_count: 10,
      },
      {
        ...
        description: "Advanced strategies for complex problems",
        difficulty: "Advanced",
        order: 8,
        lesson_count: 10,
      },
      {
        ...
        description: "Time management and accuracy under pressure",
        difficulty: "Advanced",
        order: 9,
        lesson_count: 10,
      },
      {
        ...
        description: "Full-length aptitude test simulations",
        difficulty: "Advanced",
        order: 10,
        lesson_count: 10,
      },
  ...
  "learn-chemistry": {
    ...
    modules: [
      ...
      },
      {
        ...
        description: "Elements and periodic properties",
        difficulty: "Beginner",
        order: 2,
        lesson_count: 10,
      },
      ...
      },
      {
        ...
        description: "Coordination compounds and metallurgy",
        difficulty: "Intermediate",
        order: 5,
        lesson_count: 10,
      },
      ...
      },
      {
        ...
        description: "Chemical processes and applications",
        difficulty: "Advanced",
        order: 9,
        lesson_count: 10,
      },
      {
        ...
        description: "Chemistry of pollution and solutions",
        difficulty: "Advanced",
        order: 10,
        lesson_count: 10,
      },
  ...
  "learn-developer": {
    ...
    modules: [
      ...
      },
      {
        ...
        description: "Getting hired and freelance success",
        difficulty: "Advanced",
        order: 10,
        lesson_count: 10,
      },
  ...
  "learn-finesse": {
    ...
    modules: [
      ...
      },
      {
        ...
        description: "Leading teams and influencing others",
        difficulty: "Intermediate",
        order: 4,
        lesson_count: 10,
      },
      {
        ...
        description: "Self-awareness and empathy in workplace",
        difficulty: "Intermediate",
        order: 5,
        lesson_count: 10,
      },
      ...
      },
      {
        ...
        description: "Strategic career planning and growth",
        difficulty: "Advanced",
        order: 10,
        lesson_count: 10,
      },
  ...
  "learn-geography": {
    ...
    modules: [
      ...
      },
      {
        ...
        description: "Physical and cultural geography of India",
        difficulty: "Beginner",
        order: 2,
        lesson_count: 10,
      },
      {
        ...
        description: "Continents, countries, and major features",
        difficulty: "Beginner",
        order: 3,
        lesson_count: 10,
      },
      {
        ...
        description: "Resources, industries, and trade patterns",
        difficulty: "Intermediate",
        order: 4,
        lesson_count: 10,
      },
      {
        ...
        description: "Demographics and migration patterns",
        difficulty: "Intermediate",
        order: 5,
        lesson_count: 10,
      },
      ...
      },
      {
        ...
        description: "Cities, urbanization, and planning",
        difficulty: "Advanced",
        order: 8,
        lesson_count: 10,
      },
      {
        id: 9,
        title: "GIS & Mapping",
        description: "Geographic Information Systems and cartography",
        difficulty: "Advanced",
        order: 9,
        lesson_count: 10,
      },
      {
        ...
        description: "Geography for competitive exams",
        difficulty: "Advanced",
        order: 10,
        lesson_count: 10,
      },
    ...
    modules: [
      {
        ...
        description: "Core concepts of management theory",
        difficulty: "Beginner",
        order: 1,
        lesson_count: 10,
      },
      {
        ...
        description: "Understanding people in organizations",
        difficulty: "Beginner",
        order: 2,
        lesson_count: 10,
      },
      {
        ...
        description: "Recruiting, training, and managing talent",
        difficulty: "Beginner",
        order: 3,
        lesson_count: 10,
      },
      ...
      },
      {
        ...
        description: "Long-term planning and competitive strategy",
        difficulty: "Advanced",
        order: 7,
        lesson_count: 10,
      },
    ...
    modules: [
      {
        id: 1,
        title: "Mechanics",
        description: "Motion, force, and energy fundamentals",
        difficulty: "Beginner",
        order: 1,
        lesson_count: 10,
      },
      ...
      },
      {
        ...
        description: "Atomic structure and nuclear reactions",
        difficulty: "Advanced",
        order: 8,
        lesson_count: 10,
      },
      {
        id: 9,
        title: "Astrophysics",
        description: "Celestial mechanics and cosmology",
        difficulty: "Advanced",
        order: 9,
        lesson_count: 10,
      },
      {
        ...
        description: "Physics in engineering and technology",
        difficulty: "Advanced",
        order: 10,
        lesson_count: 10,
      },
    ...
    modules: [
      {
        ...
        description: "Core principles of public relations",
        difficulty: "Beginner",
        order: 1,
        lesson_count: 10,
      },
      {
        ...
        description: "Working with journalists and media outlets",
        difficulty: "Beginner",
        order: 2,
        lesson_count: 10,
      },
      {
        ...
        description: "Press releases and PR content creation",
        difficulty: "Beginner",
        order: 3,
        lesson_count: 10,
      },
      {
        ...
        description: "Managing brand reputation online",
        difficulty: "Intermediate",
        order: 4,
        lesson_count: 10,
      },
      {
        ...
        description: "Managing communication during crises",
        difficulty: "Intermediate",
        order: 5,
        lesson_count: 10,
      },
      {
        ...
        description: "Planning and executing PR events",
        difficulty: "Intermediate",
        order: 6,
        lesson_count: 10,
      },
      {
        ...
        description: "Creating and maintaining brand image",
        difficulty: "Advanced",
        order: 7,
        lesson_count: 10,
      },
      {
        ...
        description: "Working with influencers and advocates",
        difficulty: "Advanced",
        order: 8,
        lesson_count: 10,
      },
      {
        ...
        description: "Tracking and measuring PR success",
        difficulty: "Advanced",
        order: 9,
        lesson_count: 10,
      },
      {
        id: 10,
        title: "PR Strategy",
        description: "Developing comprehensive PR campaigns",
        difficulty: "Advanced",
        order: 10,
        lesson_count: 10,
      },
