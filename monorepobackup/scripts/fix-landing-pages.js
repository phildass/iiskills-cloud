...
function getAppContent(appId) {
  ...
  const contentMap = {
    "learn-ai": {
      ...
      description:
        "Transform your career with comprehensive AI training. Learn AI fundamentals to advanced techniques and discover multiple earning opportunities.",
      features: [
        {
          emoji: "🤖",
    ...
    "learn-chemistry": {
      ...
      description:
        "Build a strong foundation in chemistry with interactive lessons covering all key topics from basic concepts to advanced principles.",
      features: [
        {
          emoji: "⚗️",
    ...
    "learn-cricket": {
      ...
      description:
        "Learn cricket techniques, rules, and strategies from basics to advanced gameplay. Perfect for players and enthusiasts.",
      features: [
        {
          emoji: "🏏",
    ...
    "learn-geography": {
      ...
      description:
        "Discover the world through comprehensive geography lessons covering physical features, cultures, and global relationships.",
      features: [
        {
          emoji: "🌍",
          title: "World Regions",
    ...
    "learn-leadership": {
      ...
      description:
        "Build essential leadership capabilities to inspire teams, drive change, and achieve organizational success.",
      features: [
        {
          emoji: "👥",
    ...
    "learn-management": {
      ...
      description:
        "Learn core management concepts, techniques, and best practices to excel in business and organizational leadership.",
      features: [
        {
          emoji: "📊",
    ...
    "learn-math": {
      ...
      description:
        "Build strong mathematical foundations from arithmetic to advanced calculus with step-by-step lessons and practice.",
      features: [
        {
          emoji: "🔢",
          title: "Core Concepts",
    ...
    "learn-physics": {
      ...
      description:
        "Explore the fundamental laws of nature through interactive physics lessons covering mechanics, energy, and modern physics.",
      features: [
        {
          emoji: "⚛️",
    ...
    "learn-pr": {
      ...
      description:
        "Learn PR strategies, media relations, and communication skills to build and maintain a positive public image.",
      features: [
        {
          emoji: "📢",
    ...
    "learn-winning": {
      ...
      description:
        "Build mental toughness, positive habits, and success strategies to achieve your personal and professional goals.",
      features: [
        {
          emoji: "🎯",
          title: "Goal Setting",
      ...
      features: [
        {
          ...
          description: "In-depth lessons and learning materials",
        },
        {
          emoji: "🎯",
          title: "Structured Learning",
          description: "Follow a clear path from basics to advanced",
        },
        {
          emoji: "✅",
