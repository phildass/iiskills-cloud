...
const PLAYERS_DATA = {
  player_1: {
    ...
    summary:
      "One of the greatest batsmen of all time, known for his aggressive batting style and exceptional chase record.",
    stats: {
      matches: 254,
      runs: 12311,
      wickets: 4,
  ...
  player_4: {
    ...
    bowlingStyle: "Right-arm medium",
    summary:
      "Legendary captain and finisher, known for his calm demeanor and match-winning abilities.",
    stats: {
      matches: 350,
      runs: 10773,
      wickets: 1,
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <div className="flex items-start justify-between mb-6">
              <div>
                ...
                <div className="flex items-center gap-4 text-gray-600">
                  <span className="flex items-center gap-2">🌍 {player.country}</span>
                  <span className="flex items-center gap-2">🏏 {player.role}</span>
                </div>
              </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-6">
              ...
              <p className="text-gray-700 leading-relaxed">{player.summary}</p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600 mb-1">{player.stats.matches}</div>
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600 mb-1">{player.stats.wickets}</div>
                <div className="text-sm text-gray-600">Wickets</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600 mb-1">{player.stats.average}</div>
