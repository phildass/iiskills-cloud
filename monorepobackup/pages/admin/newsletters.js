      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">View, preview, and manage Skilling newsletters</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h2 className="text-xl font-bold text-gray-800 mb-4">📰 Recent Newsletters</h2>
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <h3 className="font-bold text-gray-800 mb-1">{newsletter.title}</h3>
                        ...
                        <div className="text-xs text-gray-500">
                          {newsletter.sent_at ? (
                            <span>
                              ...
                              {newsletter.sent_count} recipients
                            </span>
                          ) : (
