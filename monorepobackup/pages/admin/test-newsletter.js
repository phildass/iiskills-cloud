...
export default function TestNewsletterGenerator() {
  ...
  const sampleCourse = {
    ...
    short_description:
      "Learn Python programming, data analysis, and machine learning in this comprehensive course",
    highlights: [
  ...
  async function testGeneration() {
    ...
    try {
      ...
      const { generateNewsletterContent, generateEmailHTML } =
        await import("../../lib/ai-newsletter-generator");
      ...
      <div className="min-h-screen bg-gray-50 py-8 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            <h1 className="text-2xl font-bold text-gray-800 mb-4">🧪 Test Newsletter Generator</h1>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              ...
              <p className="text-sm text-gray-700">
                <strong>Title:</strong> {sampleCourse.title}
                <br />
                <strong>Category:</strong> {sampleCourse.category}
                <br />
                <strong>Duration:</strong> {sampleCourse.duration}
                <br />
          ...
          {result && (
            <>
              {/* Content Preview */}
              <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                <h2 className="text-xl font-bold text-gray-800 mb-4">Generated Content</h2>

                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-1">Title:</label>
                    <div className="bg-gray-50 p-3 rounded border">{result.content.title}</div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-3 rounded border">{result.content.intro_text}</div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-3 rounded border">{result.content.fun_fact}</div>
                  </div>

                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-1">CTA:</label>
                    <div className="bg-gray-50 p-3 rounded border">{result.content.cta_text}</div>
                  </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h2 className="text-xl font-bold text-gray-800 mb-4">HTML Email Preview</h2>
