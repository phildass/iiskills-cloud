...
export const QUESTION_BANK = {
  ...
  numerical: [
    ...
    },
    {
      ...
      question:
        "A shopkeeper marks an item 40% above cost price and then gives a 20% discount. What is his profit percentage?",
      options: ["8%", "10%", "12%", "15%"],
      correctAnswer: 2,
      explanation:
        "Let CP = 100. Marked price = 140. After 20% discount = 140 × 0.8 = 112. Profit = 12%",
    ...
    },
    {
      ...
      question:
        "Two pipes A and B can fill a tank in 12 and 16 hours respectively. If both pipes are opened together, how long will it take to fill the tank?",
      options: ["6.5 hours", "6.75 hours", "6.85 hours", "7 hours"],
      correctAnswer: 2,
      explanation:
        "A's rate = 1/12, B's rate = 1/16. Combined = 1/12 + 1/16 = 7/48. Time = 48/7 ≈ 6.85 hours",
    ...
    },
    {
      ...
      difficulty: DIFFICULTY_LEVELS.EXPERT,
      question:
        "A mixture contains milk and water in the ratio 5:3. If 16 liters of water is added, the ratio becomes 5:7. What was the original quantity of mixture?",
      options: ["24 liters", "32 liters", "40 liters", "48 liters"],
      correctAnswer: 1,
      explanation:
        "Let original milk = 5x, water = 3x. After adding: 5x/(3x+16) = 5/7 → 35x = 15x + 80 → x = 4. Original = 8x = 32 liters",
  ...
  logical: [
    ...
    },
    {
      ...
      difficulty: DIFFICULTY_LEVELS.HARD,
      question:
        "If in a code language, '253' means 'books are old', '546' means 'man is old', and '378' means 'buy good books', what is the code for 'are'?",
      options: ["2", "3", "5", "Cannot be determined"],
      correctAnswer: 0,
      explanation:
        "Comparing statements: 'old' is common in 1 and 2, so '5'. 'books' is common in 1 and 3, so '3'. Therefore 'are' is '2'",
    ...
    },
    {
      ...
      difficulty: DIFFICULTY_LEVELS.HARD,
      question:
        "In a row of students, John is 7th from the left and 12th from the right. How many students are there in the row?",
      options: ["17", "18", "19", "20"],
      correctAnswer: 1,
      explanation:
        "Total students = Position from left + Position from right - 1 = 7 + 12 - 1 = 18",
  ...
  verbal: [
    {
      ...
      correctAnswer: 1,
      explanation:
        "Meticulous means showing great attention to detail, which is similar to careful",
    ...
    },
    {
      ...
      correctAnswer: 0,
      explanation:
        "Abundant means existing in large quantities; scarce means insufficient or lacking",
    ...
    },
    {
      ...
      difficulty: DIFFICULTY_LEVELS.HARD,
      question:
        "Choose the most appropriate word to fill the blank: The committee's decision was _____ by all members.",
    ...
    },
    {
      ...
      difficulty: DIFFICULTY_LEVELS.EXPERT,
      question:
        "Identify the correct use of idiom: 'She decided to _____ when things got difficult.'",
      options: ["throw in the towel", "throw the towel in", "throw in a towel", "throw the towel"],
      correctAnswer: 0,
  ...
  spatial: [
    {
      ...
      difficulty: DIFFICULTY_LEVELS.EASY,
      question:
        "Which shape comes next in the pattern: Circle, Square, Triangle, Circle, Square, ?",
    ...
    },
    {
      ...
      difficulty: DIFFICULTY_LEVELS.MEDIUM,
      question:
        "If a cube is painted on all faces and then cut into 27 smaller cubes of equal size, how many small cubes will have paint on exactly two faces?",
      options: ["8", "12", "18", "20"],
      correctAnswer: 1,
      explanation:
        "The cubes on the edges (but not corners) have exactly 2 painted faces. There are 12 such edges",
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "A valid cube net must be able to fold into a cube. The T-shape with 4 squares in a row works",
    ...
    },
    {
      ...
      difficulty: DIFFICULTY_LEVELS.HARD,
      question:
        "A rectangular paper is folded along its diagonal. What shape does the overlapping region form?",
      options: ["Triangle", "Rectangle", "Trapezoid", "Pentagon"],
      correctAnswer: 0,
      explanation:
        "When a rectangle is folded along its diagonal, the overlapping region forms a triangle",
    ...
    },
    {
      ...
      difficulty: DIFFICULTY_LEVELS.HARD,
      question:
        "If you look at a clock in a mirror when it shows 3:15, what time will the mirror image show?",
    ...
    },
    {
      ...
      difficulty: DIFFICULTY_LEVELS.EXPERT,
      question:
        "A cube is rotated 90° clockwise around its vertical axis. Which face that was originally on top is now facing you?",
      options: ["Front", "Back", "Left", "Right"],
      correctAnswer: 2,
      explanation:
        "After 90° clockwise rotation around vertical axis, the left face comes to the front",
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "A dodecahedron (12 pentagonal faces) has 20 vertices (using Euler's formula: V-E+F=2)",
  ...
  dataInterpretation: [
    {
      ...
      difficulty: DIFFICULTY_LEVELS.EASY,
      question:
        "A bar chart shows sales: Jan-100, Feb-150, Mar-200. What is the percentage increase from Jan to Mar?",
    ...
    },
    {
      ...
      difficulty: DIFFICULTY_LEVELS.MEDIUM,
      question:
        "A pie chart shows market share: Company A-40%, B-25%, C-20%, D-?%. What is D's share?",
      options: ["10%", "15%", "20%", "25%"],
      correctAnswer: 1,
    ...
    },
    {
      ...
      difficulty: DIFFICULTY_LEVELS.HARD,
      question:
        "A table shows: Product A sold 200 units at $50, Product B sold 150 units at $70. What's the average revenue per unit?",
      options: ["$58.57", "$60.00", "$62.50", "$65.00"],
      correctAnswer: 0,
      explanation:
        "Total revenue = (200×50)+(150×70) = 10000+10500 = 20500. Total units = 350. Avg = 20500/350 = $58.57",
    ...
    },
    {
      ...
      difficulty: DIFFICULTY_LEVELS.HARD,
      question:
        "A line graph shows temperature: 8am-20°C, 12pm-28°C, 4pm-24°C. What's the average rate of temperature change from 8am to 12pm per hour?",
    ...
    },
    {
      ...
      difficulty: DIFFICULTY_LEVELS.EXPERT,
      question:
        "Given standard deviation = 5 and mean = 50 in a normal distribution, what percentage of data falls between 45 and 55?",
      options: ["34%", "68%", "95%", "99.7%"],
      correctAnswer: 1,
      explanation:
        "45 to 55 is within ±1 standard deviation from mean. In normal distribution, this contains ~68% of data",
...
export const DOMAIN_SUPERPOWERS = {
  [COGNITIVE_DOMAINS.NUMERICAL]: {
    poor: {
      ...
      message:
        "You're developing Financial Literacy. Practice more to unlock Pro Banker potential!",
    },
    average: {
      title: "📊 Number Cruncher",
      message:
        "Solid Financial Literacy! You're ready for data-driven roles in business and analytics.",
    },
    good: {
      title: "💎 Financial Wizard",
      message:
        "Strong Financial Literacy! Top 25% - perfect for banking, finance, and strategic planning.",
    },
    excellent: {
      title: "🏆 Pro Banker",
      message:
        "Outstanding Financial Literacy! Top 5% - you have what it takes for senior finance roles and investment banking.",
    },
  },
  [COGNITIVE_DOMAINS.LOGICAL]: {
    poor: {
      title: "🔍 Pattern Seeker",
      message: "You're building Systematic Thinking. Keep practicing to sharpen your logical edge!",
    },
    average: {
      title: "⚙️ Logic Engine",
      message:
        "Good Systematic Thinking! You can tackle structured problems in tech and operations.",
    },
    good: {
      title: "🧩 Strategic Mind",
      message:
        "Strong Systematic Thinking! Top 25% - excellent for consulting, programming, and problem-solving roles.",
    },
    excellent: {
      title: "🎯 Strategic Genius",
      message:
        "Exceptional Systematic Thinking! Top 5% - you're wired for consulting, strategy, and complex problem-solving.",
    },
  },
  [COGNITIVE_DOMAINS.VERBAL]: {
    poor: {
      title: "📝 Word Builder",
      message:
        "You're developing Communication Authority. Practice to unlock persuasion and influence skills!",
    },
    average: {
      title: "💬 Clear Communicator",
      message:
        "Solid Communication Authority! You can express ideas clearly in professional settings.",
    },
    good: {
      title: "🎤 Persuasion Master",
      message:
        "Strong Communication Authority! Top 25% - ideal for marketing, sales, and leadership roles.",
    },
    excellent: {
      title: "🏅 Communication Authority",
      message:
        "Outstanding Verbal Ability! Top 5% - you have the persuasion power for executive and leadership positions.",
    },
  },
  [COGNITIVE_DOMAINS.SPATIAL]: {
    poor: {
      ...
      message:
        "You're building Design Intuition. Practice spatial problems to unlock creative potential!",
    },
    average: {
      title: "🖌️ Visual Thinker",
      message:
        "Good Design Intuition! You can work with visual and spatial concepts in design and engineering.",
    },
    good: {
      title: "🏗️ Spatial Architect",
      message:
        "Strong Design Intuition! Top 25% - perfect for architecture, UI/UX, and creative design roles.",
    },
    excellent: {
      title: "🌟 Design Visionary",
      message:
        "Exceptional Design Intuition! Top 5% - you're built for architecture, 3D design, and creative innovation.",
    },
  },
  [COGNITIVE_DOMAINS.DATA_INTERPRETATION]: {
    poor: {
      title: "📈 Data Learner",
      message:
        "You're building Strategic Insight. Practice interpreting data to unlock analytical power!",
    },
    average: {
      title: "📊 Data Reader",
      message: "Good Strategic Insight! You can analyze basic data patterns and trends.",
    },
    good: {
      title: "🔬 Analytics Pro",
      message:
        "Strong Strategic Insight! Top 25% - ready for business intelligence and data analyst roles.",
    },
    excellent: {
      title: "💡 Strategic Insight",
      message:
        "Outstanding Data Interpretation! Top 5% - you're equipped for data science, analytics, and strategic decision-making.",
    },
  },
};
...
export function getQuestionsByDomain(domain, difficulty = null) {
  const domainKey = Object.keys(QUESTION_BANK).find(
    (key) => QUESTION_BANK[key][0]?.domain === domain
  );
