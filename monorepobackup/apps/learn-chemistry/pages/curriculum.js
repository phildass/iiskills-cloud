  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Complete AI course curriculum with 10 modules and 100 lessons"
        />
      </Head>
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="card">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start">
                  ...
                  <span>
                    <strong>10 Comprehensive Modules</strong> covering beginner to advanced topics
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="font-semibold mr-2">📖</span>
                  <span>
                    <strong>100 Detailed Lessons</strong> with hands-on examples and exercises
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="font-semibold mr-2">⏱️</span>
                  <span>
                    <strong>Self-Paced Learning</strong> - Complete at your own speed, typically 3
                    months
                  </span>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  <span className="font-semibold mr-2">💼</span>
                  <span>
                    <strong>5 Real-World Case Studies</strong> - Learn from practical applications
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="font-semibold mr-2">🛠️</span>
                  <span>
                    <strong>5 Skill Simulators</strong> - Practice AI tools and techniques
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="max-w-4xl mx-auto mt-16 card bg-blue-50">
            ...
            <p className="text-gray-700 mb-4">
              This course is designed to be completed in approximately <strong>3 months</strong>{" "}
            ...
            <p className="text-gray-700 mt-4">
              <strong>Faster completion possible:</strong> Motivated learners can complete the
              course in as little as 6-8 weeks.
            </p>
          </div>
        </div>
      </main>
