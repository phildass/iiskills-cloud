...
const INTERMEDIATE_QUESTIONS = [
  {
    ...
    options: [
      ...
      "In order of increasing atomic number, grouped by similar chemical properties",
  ...
  {
    question: "In a chemical reaction, what does the Law of Conservation of Mass state?",
    options: [
      "Mass is created during exothermic reactions",
      "The total mass of reactants equals the total mass of products",
      "Mass decreases as energy is released",
      "Only elements on the left side of the periodic table conserve mass"
    ],
    correctAnswer: 1
  },
  {
...
const ADVANCED_QUESTIONS = [
  {
    question: "In organic chemistry, what is a nucleophile?",
    options: [
      "An electron-deficient species that attacks electron-rich centres",
      "An electron-rich species that donates electrons to an electron-deficient centre",
      "A catalyst that speeds up organic reactions without being consumed",
      "A type of organic solvent used in reactions"
    ],
    correctAnswer: 1
  },
  {
    question: "What does Gibbs Free Energy (ΔG) tell us about a chemical reaction?",
    options: [
      "The rate at which the reaction proceeds",
      "Whether the reaction is spontaneous (ΔG < 0) or non-spontaneous (ΔG > 0) under given conditions",
  ...
  {
    question: "Which of the following best describes an SN2 reaction in organic chemistry?",
    options: [
      "A two-step reaction proceeding through a stable carbocation intermediate",
      "A one-step bimolecular reaction where the nucleophile attacks and the leaving group departs simultaneously",
      "A reaction that only occurs with primary substrates at high temperature",
      "A reaction mechanism exclusive to aromatic compounds"
    ],
    correctAnswer: 1
  }
];
...
const LEARNING_PATHS = [
  {
    ...
    title: 'Basic',
    emoji: '🟢',
    description: 'Start with chemistry fundamentals — atoms, elements, the periodic table, and simple reactions.',
    requiresTest: false
  },
  {
    id: 'intermediate',
    title: 'Intermediate',
    emoji: '🔵',
    description: 'Apply chemistry concepts — chemical bonding, stoichiometry, reaction types, and equilibrium.',
    requiresTest: true,
  ...
  },
  {
    ...
    title: 'Advanced',
    emoji: '🟣',
    description: 'Master advanced chemistry — organic mechanisms, thermodynamics, kinetics, and analytical methods.',
    requiresTest: true,
...
export default function Onboarding() {
  ...
  const handleProceedToPayment = () => {
    window.open(`${PAYMENT_URL}?course=learn-chemistry&level=${approvedLevel}`, '_blank');
    setStep('otp');
  };
  ...
  if (step === 'success') {
    return (
      <>
        <Head>
          <title>Welcome - Learn Chemistry</title>
        </Head>
          ...
          <div className="container mx-auto px-4 max-w-2xl text-center">
            <div className="bg-white rounded-2xl shadow-lg p-10">
              ...
              <p className="text-lg text-gray-700 mb-6">
                Welcome to the <strong>{approvedLevel ? approvedLevel.charAt(0).toUpperCase() + approvedLevel.slice(1) : ''}</strong> path. Your Chemistry journey begins now!
              </p>
              <a
                href="/curriculum"
                className="inline-block bg-gradient-to-r from-purple-700 to-indigo-700 text-white px-8 py-4 rounded-lg font-bold text-lg hover:opacity-90 transition shadow-lg"
              >
                Go to Curriculum →
              </a>
            </div>
  ...
  if (step === 'otp') {
    return (
      <>
        <Head>
          <title>Enter OTP - Learn Chemistry</title>
        </Head>
        <main className="min-h-screen bg-gray-50 py-12">
          <div className="container mx-auto px-4 max-w-md">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <form onSubmit={handleOtpSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="000000"
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg text-center text-2xl font-bold tracking-widest focus:ring-2 focus:ring-purple-700 focus:border-purple-700"
                  />
                </div>
                {otpError && (
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-purple-700 to-indigo-700 text-white py-3 rounded-lg font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90 transition"
                >
              ...
              <div className="mt-6 text-center text-sm text-gray-500">
                <p>
                  Having problems?{' '}
                  <a href={`mailto:${SUPPORT_EMAIL}`} className="text-purple-700 underline font-semibold">
  ...
  if (step === 'payment') {
    ...
    return (
      <>
        <Head>
          <title>Proceed to Payment - Learn Chemistry</title>
        </Head>
        <main className="min-h-screen bg-gray-50 py-12">
          <div className="container mx-auto px-4 max-w-md">
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-purple-700 to-indigo-700 text-white py-4 rounded-lg font-bold text-lg hover:opacity-90 transition shadow-lg mb-3"
              >
                💳 Proceed to Payment
              </button>
              <button
  ...
  if (step === 'test' && selectedPath) {
    ...
    return (
      <>
        <Head>
          <title>{selectedPath.title} Test - Learn Chemistry</title>
        </Head>
        <main className="min-h-screen bg-gray-50 py-12">
          <div className="container mx-auto px-4 max-w-2xl">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="w-full bg-gray-200 rounded-full h-2 mb-6">
                <div
                  className="bg-gradient-to-r from-purple-700 to-indigo-700 h-2 rounded-full transition-all"
                ...
                {question.options.map((option, idx) => (
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-xl border-2 transition ${
                      selectedAnswer === idx
                        ? 'bg-purple-50 border-purple-700 shadow-md'
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 bg-gradient-to-r from-purple-700 to-indigo-700 text-white py-3 rounded-lg font-bold disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90 transition"
                >
  ...
  return (
    <>
      <Head>
        <title>Start Your Journey - Learn Chemistry</title>
        <meta name="description" content="Choose your Chemistry learning path and start your journey" />
      </Head>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            ...
            <p className="text-xl text-gray-600">
              Choose your learning path based on your current Chemistry knowledge
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {LEARNING_PATHS.map((path) => (
              <div
                key={path.id}
                className="bg-white rounded-2xl shadow-md p-6 border-2 border-gray-200 hover:border-purple-500 hover:shadow-lg transition-all cursor-pointer"
              ...
              >
                ...
                <button className="w-full bg-gradient-to-r from-purple-700 to-indigo-700 text-white py-3 rounded-lg font-bold hover:opacity-90 transition">
