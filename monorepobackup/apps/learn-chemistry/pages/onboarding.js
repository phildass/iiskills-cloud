...
const LEARNING_PATHS = [
  {
    ...
    emoji: "🟢",
    description:
      "Start with chemistry fundamentals — atoms, elements, the periodic table, and simple reactions.",
    requiresTest: false,
  },
  {
    id: "intermediate",
    ...
    emoji: "🔵",
    description:
      "Apply chemistry concepts — chemical bonding, stoichiometry, reaction types, and equilibrium.",
    requiresTest: true,
  ...
  },
  {
    ...
    emoji: "🟣",
    description:
      "Master advanced chemistry — organic mechanisms, thermodynamics, kinetics, and analytical methods.",
    requiresTest: true,
          ...
          <div className="container mx-auto px-4 max-w-2xl text-center">
            <div className="bg-white rounded-2xl shadow-lg p-10">
              ...
              <p className="text-lg text-gray-700 mb-6">
                ...
                path. Your Chemistry journey begins now!
              </p>
              <a
                href="/curriculum"
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Choose your Chemistry learning path and start your journey"
        />
      </Head>
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Start Your Chemistry Journey</h1>
