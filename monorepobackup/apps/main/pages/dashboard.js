          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg mb-6">
                <h2 className="text-2xl font-bold text-charcoal mb-4">Welcome back! 👋</h2>
              ...
              <div className="bg-blue-50 border border-blue-200 p-6 rounded-lg mb-6">
                ...
                <p className="text-blue-800">
                  This page uses the{" "}
                  <code className="bg-blue-100 px-2 py-1 rounded">UserProtectedRoute</code>{" "}
                  component to ensure only authenticated users can access it. If you weren't logged
                  in, you would have been automatically redirected to the login page.
                </p>
              </div>
