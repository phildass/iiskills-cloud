                  ...
                  <div className="mt-2">
                    ...
                    <div className="flex gap-2 mt-1">
                      {bundle.apps.map((appId) => (
                        <span
                          key={appId}
                          className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-purple-200 text-purple-800"
                        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {Object.values(APPS).map((app) => {
              ...
              return (
                <div
                  key={app.id}
                  className={`border rounded-lg p-4 ${isFree ? "bg-green-50 border-green-200" : "bg-blue-50 border-blue-200"}`}
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="flex gap-2 mt-1">
                        <span
                          className={`text-xs px-2 py-1 rounded ${isFree ? "bg-green-500 text-white" : "bg-blue-600 text-white"}`}
                        >
                          {isFree ? "FREE" : "PAID"}
                        </span>
                        {isBundle && (
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <span className="font-medium text-gray-900">
                                {APPS[access.app_id]?.name || access.app_id}
                              </span>
                              <span
                                className={`text-xs px-2 py-1 rounded ${
                                  access.granted_via === "payment"
                                    ? "bg-green-100 text-green-800"
                                    : access.granted_via === "bundle"
                                      ? "bg-purple-100 text-purple-800"
                                      : access.granted_via === "admin"
                            ...
                            {access.payments && (
                              <p className="text-sm text-gray-600">
                                ...
                                {access.payments.bundle_apps &&
                                  access.payments.bundle_apps.length > 1 &&
