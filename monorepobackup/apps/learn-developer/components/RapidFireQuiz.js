    ...
    return (
      ...
      >
        <div className="text-center">
          <div className="text-6xl mb-4">{isExcellence ? "🏆" : isPass ? "🎉" : "❌"}</div>
          <h3
            className={`text-2xl font-bold mb-4 ${
              isExcellence ? "text-purple-800" : isPass ? "text-green-800" : "text-red-800"
            }`}
          >
            {isExcellence
          ...
          <p className="text-xl mb-6 text-gray-700">{percentage.toFixed(1)}% Score</p>

          {isExcellence && (
            <div className="mb-6 p-4 bg-white rounded-lg">
              <p className="text-gray-800 font-semibold">🌟 Outstanding Performance! 🌟</p>
              <p className="text-gray-600 mt-2">
                You've demonstrated exceptional mastery of {moduleTitle}. Your dedication to
          ...
          {isFail && (
            <div className="mb-6 p-4 bg-white rounded-lg">
              ...
              <p className="text-gray-600 mt-2">
                Review the lesson material and try again. You need at least 30% to pass (2 out of 5
                questions).
              </p>
