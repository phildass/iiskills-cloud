# Learn Physics - Comprehensive AI Course Platform
...
Learn Physics is a self-paced online course platform designed to take students from AI fundamentals to monetization strategies. The platform includes:
...
NEXT_PUBLIC_APP_ID=learn-physics
...
# Build the app
cd apps/learn-physics && yarn build && cd ../..
...
# Deploy with PM2
pm2 start ecosystem.config.js --only learn-physics
```
