  ...
  try {
    ...
    if (!normalizedMessage.startsWith("what should i do")) {
      return res.status(200).json({
        message:
          "I'm sorry, I only provide advice for questions starting with 'What should I do...'",
      });
    }
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a helpful life advisor. Provide concise, actionable, and empathetic advice.",
        },
        {
          role: "user",
          content: message,
