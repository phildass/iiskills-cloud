  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Comprehensive UPSC IAS preparation with AI-powered content, mock interviews, daily practice tests, and personalized study plans. Master General Studies, Optional Subjects, and Ethics."
        />
      </Head>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="max-w-6xl mx-auto px-4 text-center text-white">
                ...
                <p className="text-xl mb-6 max-w-2xl mx-auto drop-shadow-lg">
                  AI-powered lessons, mock interviews, daily practice tests, and comprehensive
                  coverage of all GS papers
                </p>
                ...
                <div className="inline-block bg-white text-primary px-8 py-4 rounded-lg mb-8 shadow-2xl">
                  ...
                  <div className="text-4xl font-bold">
                    ₹99 <span className="text-lg font-normal">+ GST ₹17.82</span>
                  </div>
                ...
                {!user && (
                  <div className="bg-white/90 backdrop-blur-sm border-2 border-blue-300 rounded-lg p-4 mb-6 max-w-2xl mx-auto">
                    ...
                    <p className="text-sm mt-2 text-gray-700">
                      Create a free account to access all learning content. Register once, access
                      all iiskills.cloud apps!
                    </p>
                  </div>
                )}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="card">
                ...
                <p className="text-gray-600">Monitor your progress across all phases and modules</p>
              </div>
            </div>
          </div>
        </section>
                        ...
                        <div className="mt-4">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {phase.modules.slice(0, 5).map((module) => (
                              <span
                                key={module.id}
                                className="bg-neutral px-3 py-1 rounded-full text-sm text-gray-700"
                              >
                                {module.name}
                              </span>
                            ))}
        ...
        <section className="py-16 px-4 bg-neutral">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-sm text-primary font-semibold mb-8">
              Note: Only English Literature is included from Indian Literature group (no other
              Indian languages)
            </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {optionals.map((optional) => (
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">{optional.papers?.join(", ")}</p>
                  {optional.note && (
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-primary to-accent text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Join thousands of aspirants preparing for UPSC Civil Services with our AI-powered
              platform
            </p>
