...
export async function getCurrentUser() {
  ...
  try {
    ...
    if (isAuthDisabled) {
      console.log("⚠️ AUTH DISABLED [learn-winning]: Returning mock user");
      return {
        id: 'dev-override-winning',
...
export function getSiteUrl() {
  return (
    ...
    (typeof window !== "undefined" ? window.location.origin : "http://localhost:3022")
  );
}
