...
export default function Jobs() {
      ...
      const mockJobs = [
        {
          ...
          aiProcessed: true,
          aiSummary:
            "KPSC is recruiting for 450 positions across various departments. Graduates between 21-35 years can apply before March 15, 2026.",
        ...
        },
        {
          ...
          aiProcessed: true,
          aiSummary:
            "SSC CGL 2026 for 8000+ posts in various central government departments. Graduates aged 18-30 can apply by Feb 28.",
          status: "closing-soon",
          matchScore: 92,
          matchReasoning: {
        ...
        },
        {
          ...
          aiProcessed: true,
          aiSummary:
            "RRB NTPC recruiting 12000+ posts. 12th pass candidates aged 18-33 can apply. Deadline: Feb 20, 2026.",
          status: "urgent",
          matchScore: 78,
          matchReasoning: {
        ...
        },
        {
          ...
          aiProcessed: true,
          aiSummary:
            "TNPSC CCSE for 320 posts across departments. Graduate candidates aged 21-32 can apply until March 25.",
          status: "new",
          matchScore: 68,
          requiredDocuments: [
            { type: "Photo", required: true },
        ...
        },
        {
          ...
          aiProcessed: true,
          aiSummary:
            "IBPS PO exam for 2500 positions in public sector banks. Graduates aged 20-30 must apply by March 1.",
          status: "closing-soon",
          matchScore: 88,
          matchReasoning: {
  ...
  const filteredJobs = jobs.filter((job) => {
    ...
    const matchesState =
      !selectedState || job.stateName === selectedState || job.stateName === "All India";
    const matchesCategory = !selectedCategory; // Would need category field in data
    const matchesQualification =
      !selectedQualification || job.minQualification === selectedQualification;

    return (
      matchesSearch && matchesJobType && matchesState && matchesCategory && matchesQualification
    );
  });
  ...
  const getJobStatus = (job) => {
    ...
    const daysSincePosted = Math.ceil(
      (new Date() - new Date(job.lastUpdated)) / (1000 * 60 * 60 * 24)
    );
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Find latest government job notifications from PSCs, SSC, Railway, Banking and more with AI-powered matching"
        />
      </Head>
            ...
            <aside className={`lg:w-64 ${showFilters ? "block" : "hidden lg:block"}`}>
              <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
                <div className="flex justify-between items-center mb-4 lg:block">
                  ...
                  <button onClick={() => setShowFilters(false)} className="lg:hidden text-gray-600">
                    ✕
                  </button>
                </div>
