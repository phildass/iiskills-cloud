      ...
      features={[
        {
          ...
          description:
            "Learn batting techniques, bowling styles, fielding strategies, and game tactics from basics to advanced levels",
        },
        {
          emoji: "📚",
          title: "Rich Cricket History",
          description:
            "Explore legendary players, historic matches, World Cup moments, and cricket's evolution across eras",
        },
        {
          emoji: "🎯",
          title: "Interactive Quizzes",
          description:
            "Test your cricket knowledge with fun quizzes, trivia challenges, and competitive games",
        },
        {
          emoji: "📊",
          title: "Stats & Records",
          description:
            "Dive into comprehensive statistics, player records, team rankings, and match analyses",
        },
        {
          emoji: "🌍",
          title: "Global Coverage",
          description:
            "Follow international cricket, domestic leagues, tournaments, and live updates from around the world",
        },
        {
          emoji: "💯",
          title: "100% Free Access",
          description:
            "All content, features, and updates completely free - just register to save your progress and personalize your experience",
        },
      ]}
      isFree={true}
