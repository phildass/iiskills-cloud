    ...
    <footer className="bg-charcoal text-white py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Comprehensive NEET preparation platform with AI-powered content for Physics,
        ...
        <div className="border-t border-gray-600 pt-6 text-center text-gray-400 text-sm">
          <p>
            © 2024 iiskills.cloud - Indian Institute of Professional Skills Development. All rights
            reserved.
          </p>
