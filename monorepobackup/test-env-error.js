...
try {
  ...
  const checks = [
    ...
    {
      test: 'Contains "NEXT_PUBLIC_SUPABASE_URL"',
      result: message.includes("NEXT_PUBLIC_SUPABASE_URL"),
    },
    {
      test: 'Contains "NEXT_PUBLIC_SUPABASE_ANON_KEY"',
      result: message.includes("NEXT_PUBLIC_SUPABASE_ANON_KEY"),
    },
  ];
