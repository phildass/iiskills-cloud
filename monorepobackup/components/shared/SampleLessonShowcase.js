      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-gray-50 rounded-2xl p-8 min-h-[400px]">
          ...
          {activeTab === "sample" && (
            <div>
              <h3 className="text-3xl font-bold mb-4 text-gray-900">
                Sample Lesson: Experience Our Teaching Style
              </h3>
              <p className="text-lg text-gray-700 mb-6">
                This sample lesson demonstrates how we break down complex concepts into digestible,
                actionable insights.
              </p>

              <div className="bg-white rounded-xl p-6 mb-6 border-2 border-blue-200">
                <p className="text-gray-700 mb-4">
                  🎓 You're about to experience a complete lesson from Module {sampleModuleId},
                  Lesson {sampleLessonId}.
                </p>
          ...
          {activeTab === "test" && (
            <div>
              <h3 className="text-3xl font-bold mb-4 text-gray-900">
                Level 1 Test: Prove Your Learning
              </h3>
              <p className="text-lg text-gray-700 mb-6">
                After completing the sample lesson, test your understanding with our Level 1
                assessment.
              </p>
