...
export default function Login() {
  ...
  return (
    <>
      <Head>
        <title>Log In - Learn Winning</title>
        <meta name="description" content="Log in to Learn Winning" />
      </Head>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-white to-blue-50 py-12 px-4">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
          ...
          <p className="text-center text-charcoal mb-6">Welcome back to Learn Winning</p>
