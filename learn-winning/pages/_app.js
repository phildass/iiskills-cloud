...
export default function App({ Component, pageProps }) {
  ...
  const subdomainSections = [
    {
      label: "Home",
      href: "/",
      description: "Welcome to Learn Winning",
    },
    {
      label: "Learning Content",
      href: "/learn",
      description: "Access Winning strategies and materials",
    },
    {
      label: "Login",
      href: "/login",
  ...
  return (
    <>
      ...
      />
      <SubdomainNavbar subdomainName="Learn Winning" sections={subdomainSections} />
      <Component {...pageProps} />
      <Footer />
    </>
  );
