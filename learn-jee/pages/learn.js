...
export default function Learn() {
  ...
  const handleLessonClick = (subject, chapterId, lessonId, isFree) => {
    ...
    if (subject === "physics" && chapterId === 1 && lessonId === 1) {
      alert(
        "FREE PREVIEW: Introduction to JEE Physics lesson would be displayed here. This is your free preview lesson!"
      );
      ...
      const handleLessonClick = (chapterId, lessonId, isFree) => {
        ...
        if (!hasPurchased && !isFree) {
          ...
          // For now, using alert as placeholder
          alert(
            "This lesson requires purchasing the full course. Price: ₹499 + GST ₹89.82 (Total: ₹588.82)"
          );
          return;
        }
        ...
        alert(
          `Lesson content for ${subject} - Chapter ${chapterId}, Lesson ${lessonId} would be displayed here.`
        );
      ...
      return (
        <>
          <Head>
            ...
            <meta
              name="description"
              content="Access your Learn JEE course - Physics, Chemistry, and Mathematics"
            />
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg mb-8">
                ...
                {!hasPurchased && (
                  <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 rounded-lg mt-4">
                    ...
                    <p className="mb-3">
                      You have free access to the first Physics lesson. Experience our teaching
                    ...
                    <div className="bg-white text-primary p-4 rounded inline-block">
                      ...
                      <div className="text-3xl font-bold">
                        {pricing.basePrice}{" "}
                        <span className="text-base font-normal">+ GST {pricing.gstAmount}</span>
                      </div>
                      <div className="text-sm mt-1">
                        Total: {pricing.totalPrice} • Lifetime Access
                      </div>
                ...
                {hasPurchased && (
                  <div className="bg-green-100 border-2 border-green-500 p-4 rounded-lg mt-4">
                    <p className="text-green-800 font-semibold">
                      ✓ You have full access to all JEE course content - Physics, Chemistry, and
                      Mathematics! ✓ You have full access to all course content!
                    </p>
                  </div>
                )}
              </div>
                        ...
                        >
                          <div className={`${subjectClasses.header} text-white p-4`}>
                            <div className="flex items-center justify-between">
                              ...
                              {!hasPurchased &&
                                !(activeSubject === "physics" && chapter.id === 1) && (
                ...
                <div className="space-y-6">
                  {courseData.map((chapter) => (
                    <div key={chapter.id} className="bg-white rounded-lg shadow-lg overflow-hidden">
                      <div
                        className={`bg-gradient-to-r ${getSubjectColor(chapter.subject)} text-white p-6`}
                      >
                        <div className="flex items-center justify-between">
                          <div>
                      ...
                      <div className="p-6">
                        <div className="space-y-3">
                          {chapter.lessons.map((lesson) => {
                            const isAccessible =
                              (chapter.id === 1 && lesson.id === 1) || hasPurchased;
                            ...
                            return (
                              <button
                                key={lesson.id}
                                onClick={() =>
                                  handleLessonClick(chapter.id, lesson.id, isFreeLesson)
                                }
                                className={`w-full text-left p-4 rounded-lg border-2 transition ${
                                  isAccessible
                                    ? "border-green-300 hover:border-green-500 hover:bg-green-50 cursor-pointer"
                ...
                {!hasPurchased && (
                  <div className="mt-8 bg-gradient-to-r from-blue-600 to-purple-700 text-white p-8 rounded-lg shadow-lg text-center">
                    ...
                    <p className="text-xl mb-6">
                      Get lifetime access to comprehensive Physics, Chemistry, and Mathematics
                      content
                    </p>
                    ...
                    <div>
                      <Link
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-block bg-white text-primary px-12 py-4 rounded-lg font-bold text-xl hover:bg-gray-100 transition shadow-lg"
                      >
                        Purchase Now →
                      </Link>
                    </div>
