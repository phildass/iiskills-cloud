        ...
        <section className="bg-gradient-to-r from-blue-600 via-blue-700 to-purple-700 text-white py-20">
          <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
              AI-generated lessons, comprehensive quizzes, and structured learning path to help you
              ace JEE
            </p>
            ...
            <div className="inline-block bg-white text-primary px-8 py-4 rounded-lg mb-8 shadow-2xl">
              ...
              <div className="text-4xl font-bold">
                {pricing.basePrice}{" "}
                <span className="text-lg font-normal">+ GST {pricing.gstAmount}</span>
              </div>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="bg-green-50 border-2 border-green-500 rounded-lg p-6 text-center">
              ...
              <p className="text-lg text-gray-700">
                The first lesson is completely FREE! Sign up to preview the course content before
                purchasing. Chapter 1, Lesson 1 is completely FREE! Sign up to preview the course
