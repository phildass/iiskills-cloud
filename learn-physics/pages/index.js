  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Master physics concepts with AI-driven lessons, structured curriculum, and comprehensive testing"
        />
      </Head>
        ...
        <section className="relative bg-gradient-to-r from-primary to-blue-600 text-white py-20">
          <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            <p className="text-2xl mb-8 max-w-3xl mx-auto">
              Master physics concepts with AI-driven lessons, structured curriculum, and
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-neutral p-8 rounded-lg shadow-lg">
                ...
                <p className="text-charcoal">
                  3 levels of physics mastery with 7-10 modules per level, covering everything from
              ...
              <div className="bg-neutral p-8 rounded-lg shadow-lg">
                ...
                <p className="text-charcoal">
                  AI-generated lessons, quizzes, and tests tailored to help you master each concept
                  effectively.
                </p>
              </div>
              ...
              <div className="bg-neutral p-8 rounded-lg shadow-lg">
                ...
                <p className="text-charcoal">
                  Track your progress through each level, module, and lesson with intuitive visual
                  indicators.
                </p>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-lg border-l-4 border-green-500">
                ...
                <p className="text-charcoal mb-4">Foundation concepts including:</p>
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg border-l-4 border-blue-500">
                ...
                <p className="text-charcoal mb-4">Advanced topics including:</p>
                <ul className="space-y-2 text-gray-700">
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg border-l-4 border-purple-500">
                ...
                <p className="text-charcoal mb-4">Modern physics including:</p>
                <ul className="space-y-2 text-gray-700">
