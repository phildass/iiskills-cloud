...
/**
 * Registration Page for Learn Physics
 * 
...
export default function Register() {
  ...
  return (
    <>
      <Head>
        <title>Register - Learn Physics</title>
        <meta name="description" content="Create your account for Learn Physics" />
      </Head>
      
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4">
        <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-lg">
          <h1 className="text-3xl font-bold text-primary mb-2 text-center">Create Your Account</h1>
          <p className="text-center text-charcoal mb-6">Join Learn Physics to master physics concepts</p>
