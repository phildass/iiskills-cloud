        ...
        <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4">
          <div className="max-w-3xl mx-auto">
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              ...
              <p className="text-2xl text-charcoal mb-6">Your Score: <strong>{score}%</strong></p>
              ...
              <div className="text-left mb-8 p-6 bg-blue-50 rounded-lg">
                ...
                {score >= 60 && score < 80 && (
                  <p className="text-yellow-700 font-semibold">Good job! Consider reviewing some concepts to strengthen your understanding.</p>
                )}
                {score < 60 && (
                  <p className="text-red-700 font-semibold">You may want to review the lessons in this module before continuing.</p>
                )}
              </div>
