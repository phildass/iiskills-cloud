    ...
    <footer className="bg-charcoal text-white py-8 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-6">
          <div>
            <h3 className="font-bold text-lg mb-4">Learn IAS</h3>
            <p className="text-gray-300 text-sm">
              Comprehensive UPSC Civil Services preparation with AI-powered lessons,
              mock interviews, and daily practice tests.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <p className="text-gray-300">Subscription: ₹116.82/year</p>
