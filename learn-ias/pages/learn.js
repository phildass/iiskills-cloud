        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
            ...
            <p className="text-gray-600">
              Continue your UPSC Civil Services preparation journey
            </p>
          </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-2 text-sm text-yellow-700">
                    Subscribe to unlock full access to all IAS preparation materials, AI features, and mock tests.
                  </p>
                  ...
                  <p className="mt-3 text-xs text-yellow-600">
                    PLACEHOLDER: Payment integration with subscription management and expiry tracking will be implemented.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {currentPhase.modules.map(module => (
                    <div key={module.id} className="border border-gray-200 rounded-lg p-4 hover:border-primary transition">
              ...
              <div className="mt-8">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {currentPhase.availableOptionals.slice(0, 6).map(optional => (
                    <div key={optional.id} className="border border-gray-200 rounded-lg p-4 hover:border-primary transition">
          ...
          <div className="bg-gradient-to-r from-primary to-accent rounded-lg shadow-lg p-6 text-white mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-white bg-opacity-20 rounded-lg p-4">
                ...
                <span className="text-xs bg-yellow-400 text-yellow-900 px-2 py-1 rounded mt-2 inline-block">Planned</span>
              </div>
              <div className="bg-white bg-opacity-20 rounded-lg p-4">
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <p className="mt-2 text-sm text-blue-700">
                  This is the initial structure for the Learn IAS platform. Course content, AI features, 
                  mock interviews, test generation, progress tracking, and notification systems are currently 
                  placeholders and will be fully implemented in upcoming phases.
                </p>
              </div>
            </div>
          </div>
