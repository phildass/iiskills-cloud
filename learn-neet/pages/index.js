  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Master NEET with AI-powered comprehensive content for Physics, Chemistry, and Biology. 2-year subscription with full syllabus coverage."
        />
      </Head>
      ...
      <main className="min-h-screen">
        ...
        <section className="relative bg-gradient-to-br from-blue-900 via-blue-700 to-purple-900 text-white">
          <div className="max-w-6xl mx-auto px-4 py-20">
            <div className="text-center">
              <h1 className="text-5xl md:text-7xl font-bold mb-6">Master NEET Preparation</h1>
              ...
              <p className="text-xl mb-12 opacity-90">
                Following the official NEET syllabus with interactive lessons, quizzes, and
                explanations
              </p>
              ...
              {!user && (
                <div className="bg-white/90 backdrop-blur-sm border-2 border-orange-300 rounded-lg p-4 mb-6 max-w-2xl mx-auto">
                  <p className="text-lg font-semibold text-gray-800">📝 Registration Required</p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                {user ? (
                  <Link
                    href="/learn"
                    className="inline-block bg-white text-primary px-12 py-5 rounded-lg font-bold text-xl hover:bg-gray-100 transition shadow-lg"
                  >
                    Go to Dashboard →
                  </Link>
                ) : (
                  <>
                    <Link
                      href="/register"
                      className="inline-block bg-accent text-white px-12 py-5 rounded-lg font-bold text-xl hover:bg-orange-600 transition shadow-lg"
                    >
                      Register Free Account
                    </Link>
                    <Link
                      href="/login"
                      className="inline-block bg-transparent border-2 border-white text-white px-12 py-5 rounded-lg font-bold text-xl hover:bg-white hover:text-primary transition"
                    >
            ...
            <div className="grid md:grid-cols-3 gap-10">
              <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-2xl shadow-lg border-2 border-blue-100">
                ...
                <p className="text-gray-700">
                  Full coverage of NEET Physics, Chemistry, and Biology syllabus with AI-generated
                  lessons, explanations, and diagrams
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-white p-8 rounded-2xl shadow-lg border-2 border-purple-100">
                ...
                <p className="text-gray-700">
                  Practice with comprehensive module tests and get instant feedback to track your
                  progress and identify weak areas
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-white p-8 rounded-2xl shadow-lg border-2 border-orange-100">
                ...
                <p className="text-gray-700">
                  Unlock exclusive premium resources, study materials, and practice papers after
                  completing modules
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-white p-8 rounded-2xl shadow-lg border-2 border-green-100">
                ...
                <p className="text-gray-700">
                  Benefit from AI-generated explanations, interactive quizzes, and visual diagrams
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-white p-8 rounded-2xl shadow-lg border-2 border-yellow-100">
                ...
                <p className="text-gray-700">
                  Full access to all content and features for 2 years - plenty of time to prepare
                  thoroughly for NEET
                </p>
              </div>
            </div>
        ...
        <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-4xl font-bold text-primary text-center mb-16">What You'll Learn</h2>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <p className="text-gray-700 mb-4">
                  From Physical World and Measurement to Modern Physics, covering mechanics,
                  thermodynamics, electromagnetism, optics, and more
                </p>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <p className="text-gray-700 mb-4">
                  Complete coverage of Physical, Organic, and Inorganic Chemistry including atomic
                  structure, chemical bonding, organic reactions, and more
                </p>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <p className="text-gray-700 mb-4">
                  In-depth study of Botany and Zoology covering cell biology, genetics, human
                  physiology, ecology, and biotechnology
                </p>
                <div className="flex flex-wrap gap-2">
          ...
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            {!user && (
              <div>
                <Link
                  href="/register"
                  className="inline-block bg-accent text-white px-14 py-5 rounded-lg font-bold text-xl hover:bg-orange-600 transition shadow-2xl"
                >
                  Subscribe Now →
                </Link>
