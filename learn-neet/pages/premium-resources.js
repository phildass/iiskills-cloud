  ...
  const premiumResources = [
    {
      ...
      description: 'Complete collection of last 10 years NEET question papers with detailed solutions',
    ...
    },
    {
      ...
      description: 'Detailed solutions to all NCERT Exemplar problems for Physics, Chemistry, and Biology',
      category: 'Solutions',
      icon: '📚',
      files: 3,
        ...
        <div className="max-w-7xl mx-auto">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-green-700">
                    You have access to all premium resources. Complete modules to unlock more content!
                  </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-orange-700">
                    Active subscription needed to access premium resources. Please complete your payment.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12 bg-white p-8 rounded-2xl shadow-lg">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                Premium resources are high-quality study materials designed to supplement your NEET preparation. 
                These resources are unlocked progressively as you complete modules and demonstrate mastery of topics.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Formula sheets, revision notes, and guides</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
