        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div key={subject.subject} className="border-b border-gray-200 pb-4 last:border-0">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-sm text-gray-600">
                      {subject.activeUsers} active users
                    </span>
                  </div>
          ...
          <div className="mt-8 bg-blue-50 border-l-4 border-blue-500 p-6 rounded-lg">
            ...
            <p className="text-blue-800">
              The analytics data shown above is mock data for demonstration purposes. In production,
              this would be connected to your database and analytics service to display real-time
              usage statistics, user engagement metrics, and performance data.
            </p>
          </div>
        </div>
      </main>
