...
export default function App({ Component, pageProps }) {
  ...
  const subdomainSections = [
    {
      label: "Home",
      href: "/",
      description: "Welcome to Learn Geography",
    },
    {
      label: "Learning Content",
      href: "/learn",
      description: "Access Geography learning materials",
    },
    {
      label: "Login",
      href: "/login",
  ...
  return (
    <>
      ...
      />
      <SubdomainNavbar subdomainName="Learn Geography" sections={subdomainSections} />
      <Component {...pageProps} />
      <Footer />
