...
This is a standalone Next.js application for the **Learn Geography** module of iiskills.cloud. It is designed to be deployed as a separate service on the subdomain `learn-geography.iiskills.cloud`.

## Overview

Explore world geography, physical features, climate patterns, cultures, and global relationships through comprehensive, free learning content.

This module provides structured learning content, interactive exercises, and certification opportunities to help learners master essential geography skills.
...
- **FREE Access:** Full access to all content with registration
...
1. **Vercel** (Recommended)
   - Deploy directly from the `learn-geography` directory
   - Set domain to `learn-geography.iiskills.cloud`
   - Add environment variables in Vercel dashboard

2. **VPS with Nginx + PM2**
   - Build the app and run with PM2 on port 3009
   - Configure Nginx reverse proxy for `learn-geography.iiskills.cloud`
