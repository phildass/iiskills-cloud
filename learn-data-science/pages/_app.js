...
export default function App({ Component, pageProps }) {
  ...
  const subdomainSections = [
    {
      label: "Home",
      href: "/",
      description: "Welcome to Learn Data Science",
    },
    {
      label: "Learning Content",
      href: "/learn",
      description: "Access Data Science learning materials",
    },
    {
      label: "Login",
      href: "/login",
  ...
  return (
    <>
      ...
      />
      <SubdomainNavbar subdomainName="Learn Data Science" sections={subdomainSections} />
      <Component {...pageProps} />
      <Footer />
    </>
  );
