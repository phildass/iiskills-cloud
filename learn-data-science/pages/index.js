...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Learn Data Science - iiskills.cloud</title>
        <meta name="description" content="Master data analysis, visualization, machine learning, and turn data into insights" />
      </Head>
      
      <main className="min-h-screen">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-r from-primary to-purple-600 text-white py-20">
          <div className="max-w-6xl mx-auto px-4 text-center">
            <h1 className="text-5xl font-bold mb-6">Learn Data Science</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-12">
              ...
              <InstallApp appName="Learn Data Science" />
</div>
          </div>
        </section>
