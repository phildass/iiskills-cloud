    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-8 right-8 bg-gradient-to-r from-primary to-blue-600 hover:from-blue-600 hover:to-primary text-white rounded-full p-5 shadow-2xl transition-all hover:scale-110 z-50 flex items-center justify-center group"
          aria-label="Open AI Assistant"
          style={{ boxShadow: '0 10px 40px rgba(0, 82, 204, 0.3)' }}
        >
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-8 right-8 w-96 h-[32rem] bg-white rounded-2xl shadow-2xl flex flex-col z-50 animate-slide-up border border-gray-200 overflow-hidden" style={{ boxShadow: '0 20px 60px rgba(0, 0, 0, 0.15)' }}>
          {/* Header */}
          <div className="bg-gradient-to-r from-primary to-blue-600 text-white px-6 py-5 flex items-center justify-between">
            ...
            <button
              ...
              className="text-white hover:bg-white hover:bg-opacity-20 transition rounded-full p-1.5"
          ...
          <form onSubmit={handleSendMessage} className="p-4 border-t border-gray-200 bg-white">
            <div className="flex space-x-2">
              <input
                ...
                className="flex-1 px-4 py-3 border border-gray-300 rounded-full focus:ring-2 focus:ring-primary focus:border-transparent outline-none text-sm bg-gray-50"
              />
              <button
                type="submit"
                disabled={!inputValue.trim() || isLoading}
                className="bg-gradient-to-r from-primary to-blue-600 hover:from-blue-600 hover:to-primary text-white rounded-full p-3 transition disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
