...
export default function App({ Component, pageProps }) {
  ...
  const subdomainSections = [
    {
      label: "Home",
      href: "/",
      description: "Welcome to Learn Management",
    },
    {
      label: "Learning Content",
      href: "/learn",
      description: "Access Management learning materials",
    },
    {
      label: "Login",
      href: "/login",
  ...
  return (
    <>
      ...
      />
      <SubdomainNavbar subdomainName="Learn Management" sections={subdomainSections} />
      <Component {...pageProps} />
      <Footer />
    </>
  );
