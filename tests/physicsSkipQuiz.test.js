/**
 * Tests for learn-physics "Skip quiz and continue" feature.
 *
 * Validates:
...
describe('learn-physics skip-quiz feature', () => {
  beforeEach(() => {
  ...
  it('noBadges flag cannot be unset by calling setItem with false string', () => {
    ...
    // (The UI never calls this, but verify the flag stays if someone sets "false")
