/**
 * Tests for learn-pr "Skip quiz and continue" feature.
 *
 * Validates:
...
describe('learn-pr skip-quiz feature', () => {
  beforeEach(() => {
  ...
  it('uses app-specific localStorage key (learn-pr-noBadges)', () => {
    expect(NO_BADGES_KEY).toBe('learn-pr-noBadges');
  });
});
