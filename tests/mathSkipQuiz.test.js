/**
 * Tests for learn-math "Skip quiz and continue" feature.
 *
 * Validates:
...
describe("learn-math skip-quiz feature", () => {
  beforeEach(() => {
  ...
  it("uses app-specific localStorage key (learn-math-noBadges)", () => {
    expect(NO_BADGES_KEY).toBe("learn-math-noBadges");
  });
});
