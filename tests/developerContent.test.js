/**
 * Tests for learn-developer content integrity.
 *
 * Validates:
...
const CONTENT_ROOT = path.resolve(__dirname, '../content/learn-developer');
...
describe('learn-developer content integrity', () => {
