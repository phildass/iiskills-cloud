/**
 * Tests for learn-ai "Skip quiz and continue" feature.
 *
 * Validates:
...
describe('learn-ai skip-quiz feature', () => {
  beforeEach(() => {
  ...
  it('uses app-specific localStorage key (learn-ai-noBadges)', () => {
    expect(NO_BADGES_KEY).toBe('learn-ai-noBadges');
  });
});
