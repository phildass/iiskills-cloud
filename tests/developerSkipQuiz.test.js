/**
 * Tests for learn-developer "Skip quiz and continue" feature.
 *
 * Validates:
...
describe('learn-developer skip-quiz feature', () => {
  beforeEach(() => {
  ...
  it('uses app-specific localStorage key (learn-developer-noBadges)', () => {
    expect(NO_BADGES_KEY).toBe('learn-developer-noBadges');
  });
});
